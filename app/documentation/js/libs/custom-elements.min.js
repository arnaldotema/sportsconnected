;(function() {
  ...
  function da(b) {
    if (!1 !== b.g) {
      ...
      for (; 0 < a.length; ) {
        for (
          var f = a.shift(), e = f.localName, f = d.get(f.localName), r = 0;
          r < f.length;
          r++
        )
          A(b.c, f[r])
  ...
  function xa() {
          ...
          if (this.nodeType === Node.TEXT_NODE) d.set.call(this, a)
            ...
            if (this.firstChild) {
              var c = this.childNodes,
                k = c.length
              if (0 < k && n(this))
                for (var e = Array(k), g = 0; g < k; g++) e[g] = c[g]
            }
            d.set.call(this, a)
    ...
    u(Node.prototype, 'appendChild', function(a) {
      if (a instanceof DocumentFragment) {
        ...
        a = K.call(this, a)
        if (n(this)) for (var e = 0; e < c.length; e++) z(b, c[e])
        return a
      }
      c = n(a)
      e = K.call(this, a)
  ...
  function za() {
    ...
    function d(a, c) {
      function e(a, e) {
        for (var c = []; a !== e; a = a.nextSibling) c.push(a)
