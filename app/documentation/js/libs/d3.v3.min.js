...
!(function() {
  ...
  function U(n) {
    function t() {
      var t = this.ownerDocument,
        e = this.namespaceURI
      return e === bo && t.documentElement.namespaceURI === bo
        ? t.createElement(n)
  ...
  function X(n, t, e) {
    ...
    function u() {
      var t,
        e = new RegExp('^__on([^.]+)' + to.requote(n) + '$')
      for (var r in this)
        if ((t = r.match(e))) {
          var i = this[r]
  ...
  function W(e) {
    var r = '.dragsuppress-' + ++Eo,
      ...
      u = to
        ...
        .on('selectstart' + r, S)
    if (
      (null == No && (No = !('onselectstart' in e) && M(e.style, 'userSelect')),
      No)
    ) {
      var o = n(e).style,
        a = o[No]
  ...
  function nn(n) {
    return n > 1 ? 0 : n < -1 ? Lo : Math.acos(n)
  }
  function tn(n) {
    return n > 1 ? Ro : n < -1 ? -Ro : Math.asin(n)
  }
  function en(n) {
  ...
  function fn(n, t, e) {
    return this instanceof fn
      ...
      ? n instanceof fn
        ...
        : n instanceof hn
        ? gn(n.l, n.a, n.b)
        : gn((n = Sn((n = to.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
      : new fn(n, t, e)
  }
  function sn(n, t, e) {
    return (
      isNaN(n) && (n = 0),
      isNaN(t) && (t = 0),
      new hn(e, Math.cos((n *= Do)) * t, Math.sin(n) * t)
    )
  }
  function hn(n, t, e) {
  ...
  function gn(n, t, e) {
    return n > 0
      ? new fn(Math.atan2(e, t) * Po, Math.sqrt(t * t + e * e), n)
      : new fn(NaN, NaN, n)
  }
  function dn(n) {
  ...
  function Sn(n, t, e) {
    var r = vn(
      ...
      i = vn((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / Vo)
    return hn(
      116 * i - 16,
      500 * (r - i),
      200 * (i - vn((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Xo))
    )
  }
  function kn(n) {
  ...
  function qn(n, t, e) {
    ...
    return (
      Go ? (Go.n = i) : (Jo = i),
      (Go = i),
      Ko || ((Qo = clearTimeout(Qo)), (Ko = 1), na(Tn)),
      i
    )
  }
  function Tn() {
    var n = Rn(),
      t = Dn() - n
    t > 24
      ? (isFinite(t) && (clearTimeout(Qo), (Qo = setTimeout(Tn, t))), (Ko = 0))
      : ((Ko = 1), na(Tn))
  }
  function Rn() {
    for (var n = Date.now(), t = Jo; t; )
      n >= t.t && t.c(n - t.t) && (t.c = null), (t = t.n)
    return n
  }
  function Dn() {
    for (var n, t = Jo, e = 1 / 0; t; )
      t.c
        ? (t.t < e && (e = t.t), (t = (n = t).n))
        : (t = n ? (n.n = t.n) : (Jo = t.n))
    return (Go = n), e
  ...
  function Un(n) {
    ...
    return function(n) {
      ...
      return function(n) {
        ...
        if (y && n % 1) return ''
        var i =
          n < 0 || (0 === n && 1 / n < 0) ? ((n = -n), '-') : '-' === a ? '' : a
        if (g < 0) {
          var l = to.formatPrefix(n, h)
          ;(n = l.scale(n)), (e = l.symbol + v)
        } else n *= g
        var M,
          _,
          b = (n = p(n, h)).lastIndexOf('.')
        if (b < 0) {
          var w = m ? n.lastIndexOf('e') : -1
          w < 0
            ? ((M = n), (_ = ''))
            : ((M = n.substring(0, w)), (_ = n.substring(w)))
        } else (M = n.substring(0, b)), (_ = t + n.substring(b + 1))
        !c && s && (M = u(M, 1 / 0))
        var S = d.length + M.length + _.length + (x ? 0 : i.length),
          k = S < f ? new Array((S = f - S + 1)).join(r) : ''
        return (
          x && (M = u(k + M, k.length ? f - _.length : 1 / 0)),
          (i += d),
          (n = M + _),
          ('<' === o
            ? i + n + k
  ...
  function On(n, t, e) {
    ...
    function i(e) {
      return t((e = n(new ua(e - 1))), 1), e
    }
    function u(n, e) {
      return t((n = new ua(+n)), e), n
    }
    function o(n, r, u) {
      var o = i(n),
        a = []
  ...
  function In(n) {
    function t(n) {
      function t(t) {
        for (var e, i, u, o = [], a = -1, l = 0; ++a < r; )
          37 === n.charCodeAt(a) &&
            (o.push(n.slice(l, a)),
            null != (i = aa[(e = n.charAt(++a))]) && (e = n.charAt(++a)),
      ...
      return (
        (t.parse = function(t) {
          ...
          var i = null != r.Z && ua !== Hn,
            u = new (i ? Hn : ua)()
          return (
            'j' in r
              ? u.setFullYear(r.y, 0, r.j)
              : 'W' in r || 'U' in r
              ? ('w' in r || (r.w = 'W' in r ? 1 : 0),
                u.setFullYear(r.y, 0, 1),
                u.setFullYear(
                  r.y,
                  0,
                  'W' in r
                    ? ((r.w + 6) % 7) + 7 * r.W - ((u.getDay() + 5) % 7)
                    : r.w + 7 * r.U - ((u.getDay() + 6) % 7)
                ))
              : u.setFullYear(r.y, r.m, r.d),
            u.setHours(r.H + ((r.Z / 100) | 0), r.M + (r.Z % 100), r.S, r.L),
            i ? u._ : u
          )
        }),
        (t.toString = function() {
    ...
    function e(n, t, e, r) {
      for (var i, u, o, a = 0, l = t.length, c = e.length; a < l; ) {
        ...
        if (37 === (i = t.charCodeAt(a++))) {
          if (
            ((o = t.charAt(a++)),
            !(u = C[o in aa ? t.charAt(a++) : o]) || (r = u(n, e, r)) < 0)
          )
            return -1
    ...
    var A = {
        ...
        j: function(n, t) {
          return Zn(1 + ia.dayOfYear(n), t, 3)
        },
        L: function(n, t) {
        ...
        U: function(n, t) {
          return Zn(ia.sundayOfYear(n), t, 2)
        },
        w: function(n) {
          return n.getDay()
        },
        W: function(n, t) {
          return Zn(ia.mondayOfYear(n), t, 2)
        },
        x: t(h),
        X: t(p),
        y: function(n, t) {
  ...
  function $n(n, t, e) {
    la.lastIndex = 0
    var r = la.exec(t.slice(e, e + 1))
    return r ? ((n.w = +r[0]), e + r[0].length) : -1
  }
  function Bn(n, t, e) {
    la.lastIndex = 0
    var r = la.exec(t.slice(e))
  ...
  function Jn(n, t, e) {
    la.lastIndex = 0
    var r = la.exec(t.slice(e, e + 4))
    return r ? ((n.y = +r[0]), e + r[0].length) : -1
  }
  function Gn(n, t, e) {
    la.lastIndex = 0
    var r = la.exec(t.slice(e, e + 2))
  ...
  function ht(n, t) {
    n && pa.hasOwnProperty(n.type) && pa[n.type](n, t)
  }
  function pt(n, t, e) {
    var r,
      i = -1,
  ...
  function dt() {
    function n(n, t) {
      ...
      var e = (n *= Do) - r,
        ...
        s = i * l + f * Math.cos(a),
        h = f * o * Math.sin(a)
      da.add(Math.atan2(h, s)), (r = n), (i = l), (u = c)
    }
    var t, e, r, i, u
    ;(va.point = function(o, a) {
      ;(va.point = n),
        (r = (t = o) * Do),
        (i = Math.cos((a = ((e = a) * Do) / 2 + Lo / 4))),
        (u = Math.sin(a))
    }),
      (va.lineEnd = function() {
        n(t, e)
  ...
  function wt(n, t) {
    return so(n[0] - t[0]) < Co && so(n[1] - t[1]) < Co
  }
  function St(n, t) {
    n *= Do
    var e = Math.cos((t *= Do))
  ...
  function kt(n, t, e) {
    ;(xa += (n - xa) / ++ya), (Ma += (t - Ma) / ya), (_a += (e - _a) / ya)
  }
  function Nt() {
    function n(n, i) {
      n *= Do
  ...
  function At() {
    ...
    ;(Aa.point = function(o, a) {
      ...
      (Aa.lineEnd = function() {
        n(t, e), (Aa.lineEnd = Et), (Aa.point = St)
      })
  }
  function Ct(n, t) {
    function e(e, r) {
      ...
      (n.forEach(function(n) {
        if (!((t = n.length - 1) <= 0)) {
          ...
          ;(l.o = c),
            u.push(l),
            o.push(c),
            (c = new Tt(r, null, (l = new Tt(r, n, null, !1)), !0)),
            (l.o = c),
            u.push(l),
            o.push(c)
        }
      ...
      var p,
        ...
        m = {
          ...
          polygonEnd: function() {
            ...
            var n = Ot(y, g)
            p.length
              ? (_ || (u.polygonStart(), (_ = !0)), Lt(p, jt, n, e, u))
              : n &&
  ...
  function jt(n, t) {
    return (
      ((n = n.x)[0] < 0 ? n[1] - Ro - Co : Ro - n[1]) -
      ((t = t.x)[0] < 0 ? t[1] - Ro - Co : Ro - t[1])
    )
  }
  function Ut(n) {
    var t,
      ...
      if (f)
        for (
          ...
          var y = (n = c[v])[0],
            ...
            k = g * x
          if (
            (da.add(Math.atan2(k * b * Math.sin(w), d * M + k * Math.cos(w))),
            (u += S ? _ + b * qo : _),
            S ^ (h >= e) ^ (y >= e))
          ) {
            var N = mt(vt(s), vt(n))
  ...
  function Yt(n) {
      ...
      return {
        ...
        point: function(s, h) {
          var p,
            g = [s, h],
            d = t(s, h),
            v = o ? (d ? 0 : i(s, h)) : d ? i(s + (s < 0 ? Lo : -Lo), h) : 0
          if (
            (!e && (c = l = d) && n.lineStart(),
            d !== l &&
              ((p = r(e, g)),
              (wt(e, p) || wt(g, p)) &&
                ((g[0] += Co), (g[1] += Co), (d = t(g[0], g[1])))),
            d !== l)
          )
            (f = 0),
              d
    ...
    function r(n, t, e) {
      ...
      if (!(v < 0)) {
        ...
        if (
          ...
          N
            ? k
              ? (b + w > 0) ^ (m[1] < (so(m[0] - M) < Co ? b : w))
              : b <= m[1] && m[1] <= w
            : (S > Lo) ^ (M <= m[0] && m[0] <= _))
        ) {
          var E = Mt(p, (-g + y) / d)
          return xt(E, h), [m, bt(E)]
        }
      }
    }
    function i(t, e) {
    ...
    var u = Math.cos(n),
      o = u > 0,
      a = so(u) > Co
    return Rt(t, e, de(n, 6 * Do), o ? [0, -n] : [-Lo, n - Lo])
  }
  function It(n, t, e, r) {
    return function(i) {
      var u,
        ...
        if (((u = e - l), h || !(u < 0))) {
          ...
          if (((u = t - c), p || !(u > 0))) {
            ...
            if (((u = r - c), p || !(u < 0))) {
              ...
              return (
                f > 0 && (i.a = { x: l + f * h, y: c + f * p }),
                s < 1 && (i.b = { x: l + s * h, y: c + s * p }),
                i
              )
            }
          }
  ...
  function Zt(n, t, e, r) {
    ...
    return function(a) {
      ...
      function p() {
        d && (g(m, x), M && w && E.rejoin(), d.push(E.buffer())),
          (C.point = s),
          w && a.lineEnd()
      }
      function g(n, t) {
        var e = f(
          (n = Math.max(-za, Math.min(za, n))),
          (t = Math.max(-za, Math.min(za, t)))
        )
        if ((v && y.push([n, t]), S))
          (m = n),
            (x = t),
  ...
  function $t() {
    ...
    var t, e, r, i
    ;(ja.point = function(u, o) {
      ;(ja.point = n), (t = r = u), (e = i = o)
    }),
      (ja.lineEnd = function() {
        n(t, e)
      })
  ...
  function Kt() {
    ...
    var t, e
    Fa.point = function(r, i) {
      ;(Fa.point = n), Gt((t = r), (e = i))
    }
  }
  function Qt() {
    Fa.point = Gt
  ...
  function ee(n) {
    ...
    function r(t) {
      ...
      function f() {
        i(x, M, m, _, b, w, p, g, s, d, v, y, a, t), (S.lineEnd = o), o()
      }
      var s,
        h,
        p,
  ...
  function ae(n) {
    function t(n) {
      return (n = a(n[0] * Do, n[1] * Do)), [n[0] * h + l, c - n[1] * h]
    }
    function e(n) {
      return (
        (n = a.invert((n[0] - l) / h, (c - n[1]) / h)) && [n[0] * Po, n[1] * Po]
      )
    }
    function r() {
      a = Ct((o = se(y, x, M)), u)
    ...
    return (
      (t.stream = function(n) {
        return f && (f.valid = !1), (f = le(_(o, s(b(n))))), (f.valid = !0), f
      }),
      (t.clipAngle = function(n) {
        return arguments.length
          ? ((_ = null == n ? ((w = n), Ca) : Yt((w = +n) * Do)), i())
          : w
      }),
      (t.clipExtent = function(n) {
        return arguments.length
          ? ((S = n), (b = n ? Zt(n[0][0], n[0][1], n[1][0], n[1][1]) : m), i())
          : S
      }),
      (t.scale = function(n) {
  ...
  function he(n) {
    return function(t, e) {
      return (t += n), [t > Lo ? t - qo : t < -Lo ? t + qo : t, e]
    }
  }
  function pe(n) {
    var t = he(n)
  ...
  function de(n, t) {
    ...
    return function(i, u, o, a) {
      ...
      for (var c, f = i; o > 0 ? f > u : f < u; f -= l)
        a.point((c = bt([e, -r * Math.cos(f), -r * Math.sin(f)]))[0], c[1])
    }
  }
  function ve(n, t) {
    var e = vt(t)
    ;(e[0] -= n), _t(e)
    var r = nn(-e[1])
    return ((-e[2] < 0 ? -r : r) + 2 * Math.PI - Co) % (2 * Math.PI)
  }
  function ye(n, t, e) {
    var r = to.range(n, t - Co, e).concat(t)
    return function(n) {
    ...
    var i = Math.cos(t),
      ...
      g = h
        ? function(n) {
            ...
            return [
              Math.atan2(i, r) * Po,
              Math.atan2(o, Math.sqrt(r * r + i * i)) * Po,
            ]
          }
        : function() {
            return [n * Po, t * Po]
  ...
  function Se(n, t) {
    ...
    return u
      ? ((e.invert = function(n, t) {
          ...
          return [
            Math.atan2(n, e) / u,
            2 * Math.atan(Math.pow(o / r, 1 / u)) - Ro,
          ]
        }),
        e)
      : Ne
  ...
  function Ne(n, t) {
    return [n, Math.log(Math.tan(Lo / 4 + t / 2))]
  }
  function Ee(n) {
    var t,
      e = oe(n),
  ...
  function Ae(n, t) {
    return [Math.log(Math.tan(Lo / 4 + t / 2)), -n]
  }
  function Ce(n) {
    return n[0]
  }
  ...
  function Ue(n) {
    Be(n), Ja.remove(n), Qa.push(n), rr(n)
  }
  function Fe(n) {
    var t = n.circle,
      e = t.x,
    ...
    for (
      var l = u;
      l.circle && so(e - l.circle.x) < Co && so(r - l.circle.cy) < Co;

    )
      (u = l.P), a.unshift(l), Ue(l), (l = u)
    a.unshift(l), Be(l)
    for (
      var c = o;
      c.circle && so(e - c.circle.x) < Co && so(r - c.circle.cy) < Co;

    )
      (o = c.N), a.push(c), Ue(c), (c = o)
    a.push(c), Be(c)
    var f,
      s = a.length
    for (f = 1; f < s; ++f)
    ...
    ;(l = a[0]),
      ((c = a[s - 1]).edge = Ke(l.site, c.site, null, i)),
      $e(l),
      $e(c)
  }
  function He(n) {
    for (var t, e, r, i, u = n.x, o = n.y, a = Ja._; a; )
      if ((r = Oe(a, o) - u) > Co) a = a.L
      else {
        if (!((i = u - Ye(a, o)) > Co)) {
          r > -Co
            ? ((t = a.P), (e = a))
    ...
    if ((Ja.insert(t, l), t || e)) {
      ...
      if (e) {
        ...
        var c = t.site,
          ...
          m = h * h + p * p,
          x = d * d + v * v,
          M = { x: (v * m - p * x) / y + f, y: (h * x - d * m) / y + s }
        nr(e.edge, c, g, M),
          (l.edge = Ke(c, n, null, M)),
          (e.edge = Ke(n, g, null, M)),
          $e(t),
          $e(e)
      } else l.edge = Ke(t.site, l.site)
    }
  }
  function Oe(n, t) {
    var e = n.site,
      ...
      if (r !== u) {
        ...
        if (!(s >= -zo)) {
          ...
          ;(y.arc = n),
            (y.site = i),
            (y.x = g + o),
            (y.y = v + Math.sqrt(g * g + d * d)),
            (y.cy = v),
            (n.circle = y)
          for (var m = null, x = Ka._; x; )
  ...
  function Be(n) {
    var t = n.circle
    t && (t.P || (Ga = t.N), Ka.remove(t), nl.push(t), rr(t), (n.circle = null))
  }
  function We(n) {
    for (
      var t, e = Ba, r = It(n[0][0], n[0][1], n[1][0], n[1][1]), i = e.length;
      i--;

    )
      (!Je((t = e[i]), n) ||
        !r(t) ||
        (so(t.a.x - t.b.x) < Co && so(t.a.y - t.b.y) < Co)) &&
  ...
  function Ke(n, t, e, r) {
    ...
    return (
      ...
      e && nr(i, n, t, e),
      r && nr(i, t, n, r),
      Wa[n.i].edges.push(new tr(i, n, t)),
      Wa[t.i].edges.push(new tr(i, t, n)),
      i
    )
  }
  function Qe(n, t, e) {
    var r = new Ge(n, null)
    return (r.a = t), (r.b = e), Ba.push(r), r
  }
  function nr(n, t, e, r) {
    n.a || n.b
      ? n.l === e
  ...
  function ar(n, t) {
    var e,
      ...
      i,
      u = n.sort(lr).pop()
    for (Ba = [], Wa = new Array(n.length), Ja = new er(), Ka = new er(); ; )
      if (((i = Ga), u && (!i || u.y < i.y || (u.y === i.y && u.x < i.x))))
        (u.x === e && u.y === r) ||
          ((Wa[u.i] = new Ie(u)), He(u), (e = u.x), (r = u.y)),
          (u = n.pop())
      else {
        if (!i) break
        Fe(i.arc)
    ...
    t && (We(t), Ze(t))
    var o = { cells: Wa, edges: Ba }
    return (Ja = Ka = Ba = Wa = null), o
  }
  function lr(n, t) {
  ...
  function yr(n, t) {
    var e,
      r,
      i,
      u = (el.lastIndex = rl.lastIndex = 0),
      o = -1,
      a = [],
      l = []
    for (n += '', t += ''; (e = el.exec(n)) && (r = rl.exec(t)); )
      (i = r.index) > u &&
  ...
  function mr(n, t) {
    for (
      var e, r = to.interpolators.length;
      --r >= 0 && !(e = to.interpolators[r](n, t));
  ...
  function jr(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (i *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Po),
      (this.translate = [n.e, n.f]),
      (this.scale = [r, u]),
      (this.skew = u ? Math.atan2(i, u) * Po : 0)
  }
  function Ur(n, t) {
    return n[0] * t[0] + n[1] * t[1]
  }
  ...
  function Yr(n, t, e, r) {
    if (n[0] !== t[0] || n[1] !== t[1]) {
      ...
      r.push({ i: i - 4, x: vr(n[0], t[0]) }, { i: i - 2, x: vr(n[1], t[1]) })
    } else (t[0] || t[1]) && e.push('translate(' + t + ')')
  }
  function Ir(n, t, e, r) {
    n !== t
      ? (n - t > 180 ? (t += 360) : t - n > 180 && (n += 360),
        r.push({ i: e.push(Or(e) + 'rotate(', null, ')') - 2, x: vr(n, t) }))
      : t && e.push(Or(e) + 'rotate(' + t + ')')
  }
  function Zr(n, t, e, r) {
    n !== t
      ? r.push({ i: e.push(Or(e) + 'skewX(', null, ')') - 2, x: vr(n, t) })
      : t && e.push(Or(e) + 'skewX(' + t + ')')
  }
  function Vr(n, t, e, r) {
    if (n[0] !== t[0] || n[1] !== t[1]) {
      var i = e.push(Or(e) + 'scale(', null, ',', null, ')')
      r.push({ i: i - 4, x: vr(n[0], t[0]) }, { i: i - 2, x: vr(n[1], t[1]) })
    } else (1 === t[0] && 1 === t[1]) || e.push(Or(e) + 'scale(' + t + ')')
  }
  function Xr(n, t) {
    var e = [],
      r = []
    return (
      ...
      Ir(n.rotate, t.rotate, e, r),
      Zr(n.skew, t.skew, e, r),
      Vr(n.scale, t.scale, e, r),
      (n = t = null),
      function(n) {
  ...
  function Wr(n) {
    for (var t = n.source, e = n.target, r = Gr(t, e), i = [t]; t !== r; )
      (t = t.parent), i.push(t)
  ...
  function Gr(n, t) {
    if (n === t) return n
    for (
      var e = Jr(n), r = Jr(t), i = e.pop(), u = r.pop(), o = null;
      i === u;
  ...
  function ri(n, t) {
    return (
      to.rebind(n, t, 'sort', 'children', 'value'),
      (n.nodes = n),
      (n.links = ci),
      n
    )
  ...
  function ki(n) {
    ...
    if ((e = n.children) && (c = e.length)) {
      ...
      if (
        ...
        for (
          ...
          if (1 == g)
            for (
              l = r._pack_prev;
              l !== a._pack_prev && !Si(l, u);
              l = l._pack_prev, v++
            );
          g
            ? (d < v || (d == v && i.r < r.r) ? wi(r, (i = a)) : wi((r = l), i),
              o--)
            : (bi(r, u), (i = u), t(u))
        }
      var y = (f + s) / 2,
      ...
      for (o = 0; o < c; o++)
        ((u = e[o]).x -= y),
          (u.y -= m),
          (x = Math.max(x, u.r + Math.sqrt(u.x * u.x + u.y * u.y)))
      ;(n.r = x), e.forEach(Ei)
    }
  }
  function Ni(n) {
  ...
  function Ai(n, t, e, r) {
    ...
    if (((n.x = t += r * n.x), (n.y = e += r * n.y), (n.r *= r), i))
      for (var u = -1, o = i.length; ++u < o; ) Ai(i[u], t, e, r)
  }
  function Ci(n, t, e) {
    var r = n.r + e.r,
      i = t.x - n.x,
  ...
  function Ii(n, t, e, r) {
    function i() {
      var i = Math.min(n.length, t.length) > 2 ? Yi : Fi,
        l = r ? Br : $r
  ...
  function Vi(n, t) {
    return Hi(n, Oi(Xi(n, t)[2])), Hi(n, Oi(Xi(n, t)[2])), n
  }
  function Xi(n, t) {
    null == t && (t = 10)
    var e = ji(n),
  ...
  function Ji(n, t) {
    var e = Wi(t[2])
    return n in dl
      ? Math.abs(e - Wi(Math.max(so(t[0]), so(t[1])))) + +('e' !== n)
      : e - 2 * ('%' === n)
  }
  function Gi(n, t, e, r) {
    function i(n) {
    ...
    return (
      ...
      (o.tickFormat = function(n, e) {
        ...
        arguments.length < 2
          ? (e = vl)
          : 'function' != typeof e && (e = to.format(e))
        var r = Math.max(1, (t * n) / o.ticks().length)
        return function(n) {
          var o = n / u(Math.round(i(n)))
          return o * t < t - 0.5 && (o *= t), o <= r ? e(n) : ''
        }
      }),
      (o.copy = function() {
  ...
  function Ki(n, t, e) {
    ...
    return (
      ...
      (r.exponent = function(o) {
        return arguments.length
          ? ((i = Qi((t = o))), (u = Qi(1 / t)), n.domain(e.map(i)), r)
          : t
      }),
      (r.copy = function() {
  ...
  function tu(n, t) {
    ...
    function o(n) {
      if (!isNaN((n = +n))) return t[to.bisect(a, n)]
    }
    var a
    return (
      (o.domain = function(t) {
  ...
  function eu(n, t, e) {
    ...
    return (
      ...
      (r.invertExtent = function(t) {
        return (t = e.indexOf(t)), (t = t < 0 ? NaN : t / u + n), [t, t + 1 / u]
      }),
      (r.copy = function() {
        return eu(n, t, e)
      }),
  ...
  function pu(n) {
    ...
    return (
      ...
      (t.interpolate = function(n) {
        return arguments.length
          ? ((o = 'function' == typeof n ? (u = n) : (u = wl.get(n) || gu).key),
            t)
          : o
      }),
  ...
  function xu(n, t) {
    return n.length < 4 ? gu(n) : n[1] + bu(n.slice(1, -1), wu(n, t))
  }
  function Mu(n, t) {
    return n.length < 3
      ? du(n)
      : n[0] + bu((n.push(n[0]), n), wu([n[n.length - 2]].concat(n, [n[1]]), t))
  }
  function _u(n, t) {
    return n.length < 3 ? gu(n) : n[0] + bu(n, wu(n, t))
  }
  function bu(n, t) {
  ...
  function Su(n) {
    ...
    var t = 1,
      ...
      o = [i, i, i, (r = n[1])[0]],
      a = [u, u, u, r[1]],
      l = [i, ',', u, 'L', Au(Nl, o), ',', Au(Nl, a)]
    for (n.push(n[e - 1]); ++t <= e; )
      (r = n[t]), o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), Cu(l, o, a)
  ...
  function ku(n) {
    ...
    for (e.push(Au(Nl, u) + ',' + Au(Nl, o)), --r; ++r < i; )
      (t = n[r]), u.shift(), u.push(t[0]), o.shift(), o.push(t[1]), Cu(e, u, o)
    return e.join('')
  }
  function Nu(n) {
    for (var t, e, r = -1, i = n.length, u = i + 4, o = [], a = []; ++r < 4; )
      (e = n[r % i]), o.push(e[0]), a.push(e[1])
    for (t = [Au(Nl, o), ',', Au(Nl, a)], --r; ++r < u; )
      (e = n[r % i]),
        o.shift(),
        o.push(e[0]),
        a.shift(),
  ...
  function Lu(n) {
    for (
      ...
      r[t] = (o + (o = zu((i = u), (u = n[t + 1])))) / 2
    return (r[t] = o), r
  }
  function qu(n) {
    for (var t, e, r, i, u = [], o = Lu(n), a = -1, l = n.length - 1; ++a < l; )
      (t = zu(n[a], n[a + 1])),
        so(t) < Co
          ? (o[a] = o[a + 1] = 0)
          : (i = (e = o[a] / t) * e + (r = o[a + 1] / t) * r) > 9 &&
            ((i = (3 * t) / Math.sqrt(i)), (o[a] = i * e), (o[a + 1] = i * r))
    for (a = -1; ++a <= l; )
      (i =
  ...
  function Tu(n) {
    return n.length < 3 ? gu(n) : n[0] + bu(n, qu(n))
  }
  function Ru(n) {
  ...
  function Du(n) {
    function t(t) {
      ...
      for (
        ...
        o.call(this, (h = t[m]), m)
          ? (v.push([(p = +M.call(this, h, m)), (g = +_.call(this, h, m))]),
    ...
    return (
      ...
      (t.interpolate = function(n) {
        return arguments.length
          ? ((l = 'function' == typeof n ? (a = n) : (a = wl.get(n) || gu).key),
            (c = a.reverse || a),
            (f = a.closed ? 'M' : 'L'),
            t)
          : l
  ...
  function Iu(n, t, e) {
    return yo(n, Tl), (n.namespace = t), (n.id = e), n
  }
  function Zu(n, t, e, r) {
    var i = n.id,
      u = n.namespace
  ...
  if (
    ...
    try {
      ...
      var uo = this.Element.prototype,
        ...
        lo = this.CSSStyleDeclaration.prototype,
        co = lo.setProperty
      ;(uo.setAttribute = function(n, t) {
        ...
        (lo.setProperty = function(n, t, e) {
          co.call(this, n, t + '', e)
        })
    }
  ;(to.ascending = e),
    (to.descending = function(n, t) {
    ...
    (to.median = function(n, t) {
      ...
      if (o.length) return to.quantile(o.sort(e), 0.5)
    }),
  ...
  var fo = u(e)
  ;(to.bisectLeft = fo.left),
    (to.bisect = to.bisectRight = fo.right),
    (to.bisector = function(n) {
      return u(
        1 === n.length
          ? function(t, r) {
              return e(n(t), r)
    ...
    (to.pairs = function(n) {
      for (
        var t = 0, e = n.length - 1, r = n[0], i = new Array(e < 0 ? 0 : e);
        t < e;
    ...
    (to.transpose = function(n) {
      ...
      for (var t = -1, e = to.min(n, o), r = new Array(e); ++t < e; )
  ...
  l(c, {
    ...
    (to.behavior = {}),
    (to.rebind = function(n, t) {
      for (var e, r = 1, i = arguments.length; ++r < i; )
        n[(e = arguments[r])] = x(n, t, t[e])
      return n
    })
  ...
  var vo = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,
    ...
    Mo = function(n, t) {
      var e = n.matches || n[M(n, 'matchesSelector')]
      return (Mo = function(n, t) {
        return e.call(n, t)
      })(n, t)
    }
  'function' == typeof Sizzle &&
    ...
    (xo = Sizzle),
    (Mo = Sizzle.matchesSelector)),
    (to.selection = function() {
      return to.select(io.documentElement)
    })
  var _o = (to.selection.prototype = [])
  ;(_o.select = function(n) {
    var t,
      e,
      r,
      i,
    ...
    (_o.selectAll = function(n) {
      ...
      for (var i = -1, u = this.length; ++i < u; )
        for (var o = this[i], a = -1, l = o.length; ++a < l; )
          (e = o[a]) &&
            (r.push((t = ro(n.call(e, e.__data__, a, i)))), (t.parentNode = e))
      return E(r)
    })
  ...
  ;(to.ns = {
    ...
    qualify: function(n) {
      ...
      return (
        ...
        wo.hasOwnProperty(e) ? { space: wo[e], local: n } : n
      )
    },
  }),
    (_o.attr = function(n, t) {
    ...
    (_o.data = function(n, t) {
      function e(n, e) {
        ...
        if (t) {
          ...
          for (r = -1; ++r < o; )
            (i = n[r]) &&
              (y.has((v = t.call(i, i.__data__, r))) ? (d[r] = i) : y.set(v, i),
              (m[r] = v))
          for (r = -1; ++r < s; )
            (i = y.get((v = t.call(e, (u = e[r]), r))))
              ? !0 !== i && ((p[r] = i), (i.__data__ = u))
              : (g[r] = H(u)),
              y.set(v, !0)
          for (r = -1; ++r < o; ) r in m && !0 !== y.get(m[r]) && (d[r] = n[r])
        } else {
          for (r = -1; ++r < h; )
            (i = n[r]),
              (u = e[r]),
  ...
  ;(to.selection.enter = Z),
    (to.selection.enter.prototype = So),
    (So.append = _o.append),
    (So.empty = _o.empty),
    (So.node = _o.node),
    (So.call = _o.call),
    (So.size = _o.size),
    (So.select = function(n) {
    ...
    (So.insert = function(n, t) {
      return arguments.length < 2 && (t = V(this)), _o.insert.call(this, n, t)
    }),
    (to.select = function(t) {
      var e
      return (
        'string' == typeof t
          ? ((e = [mo(t, io)]).parentNode = io.documentElement)
          : ((e = [t]).parentNode = n(t)),
        E([e])
      )
    }),
    (to.selectAll = function(n) {
      ...
      return (
        'string' == typeof n
          ? ((t = ro(xo(n, io))).parentNode = io.documentElement)
          : ((t = ro(n)).parentNode = null),
        E([t])
      )
    }),
    (_o.on = function(n, t, e) {
      var r = arguments.length
      if (r < 3) {
        if ('string' != typeof n) {
          r < 2 && (t = !1)
  ...
  var Ao = this.navigator && /WebKit/.test(this.navigator.userAgent) ? -1 : 0
    ...
    (to.behavior.drag = function() {
      ...
      function e(n, t, e, u, o) {
        return function() {
          ...
          function l() {
            t(h, d) &&
              (y.on(u + v, null).on(o + v, null), m(g), p({ type: 'dragend' }))
          }
          var c,
            f = this,
            s = to.event.target.correspondingElement || to.event.target,
            h = f.parentNode,
            p = r.of(f, arguments),
            g = 0,
            d = n(),
            ...
            x = t(h, d)
          i
            ? ((c = i.apply(f, arguments)), (c = [c.x - x[0], c.y - x[1]]))
            : (c = [0, 0]),
            p({ type: 'dragstart' })
        }
      }
      var r = N(n, 'drag', 'dragstart', 'dragend'),
        i = null,
        u = e(_, to.mouse, t, 'mousemove', 'mouseup'),
  ...
  ;(to.interpolateZoom = function(n, t) {
    ...
    if (h < zo)
      (r = Math.log(c / o) / jo),
        (e = function(n) {
          return [i + n * f, u + n * s, o * Math.exp(jo * n * r)]
        })
    else {
      var p = Math.sqrt(h),
      ...
      ;(r = (y - v) / jo),
        (e = function(n) {
          var t = n * r,
            e = rn(v),
            a = (o / (2 * p)) * (e * un(jo * t + v) - en(v))
          return [i + a * f, u + a * s, (o * e) / rn(jo * t + v)]
        })
    }
      ...
      function h() {
        ...
        function t() {
          ...
          to
            ...
            .on(_, a),
            b.push(t)
          for (var e = to.event.changedTouches, i = 0, u = e.length; i < u; ++i)
        ...
        function a() {
          if (to.event.touches.length) {
            for (
              var t = to.event.changedTouches, e = 0, r = t.length;
              e < r;
              ++e
            )
          ...
          to.selectAll(b).on(m, null), w.on(L, s).on(R, h), N(), f(d)
        }
        var p,
          g = this,
          d = D.of(g, arguments),
          ...
          w = to.select(g),
          N = W(g)
        t(), l(d), w.on(L, null).on(R, t)
      }
      function p() {
        var n = D.of(this, arguments)
        m
          ? clearTimeout(m)
          : (ql.call(this), (d = e((v = y || to.mouse(this)))), l(n)),
          (m = setTimeout(function() {
            ;(m = null), f(n)
          }, 50)),
          S(),
          i(Math.pow(2, 0.002 * Uo()) * k.k),
          u(v, d),
          c(n)
      }
      function g() {
        ...
        o(
          ...
          n,
          e(n),
          to.event.shiftKey ? Math.ceil(t) - 1 : Math.floor(t) + 1
        )
      }
      var d,
        v,
  ...
  ;(to.color = an),
    ...
    (to.hsl = ln)
  var Oo = (ln.prototype = new an())
  ;(Oo.brighter = function(n) {
    return (
      (n = Math.pow(0.7, arguments.length ? n : 1)),
      new ln(this.h, this.s, this.l / n)
    )
  }),
    (Oo.darker = function(n) {
      return (
        (n = Math.pow(0.7, arguments.length ? n : 1)),
  ...
  ;(Yo.brighter = function(n) {
    return new fn(
      this.h,
      this.c,
      Math.min(100, this.l + Io * (arguments.length ? n : 1))
    )
  }),
    (Yo.darker = function(n) {
      return new fn(
        this.h,
        this.c,
        Math.max(0, this.l - Io * (arguments.length ? n : 1))
      )
    }),
    (Yo.rgb = function() {
  ...
  var Io = 18,
    ...
    Vo = 1,
    Xo = 1.08883,
    $o = (hn.prototype = new an())
  ;($o.brighter = function(n) {
    return new hn(
      Math.min(100, this.l + Io * (arguments.length ? n : 1)),
      this.a,
      this.b
  ...
  Wo.forEach(function(n, t) {
    ...
    (to.csv = to.dsv(',', 'text/csv')),
    (to.tsv = to.dsv('\t', 'text/tab-separated-values'))
  var Jo,
    Go,
    Ko,
    Qo,
    na =
      this[M(this, 'requestAnimationFrame')] ||
      function(n) {
        setTimeout(n, 17)
      }
  ;(to.timer = function() {
  ...
  var ea = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
    ra = to.map({
      ...
      r: function(n, t) {
        return (n = to.round(n, Pn(n, t))).toFixed(
  ...
  ;(ia.year = On(
    function(n) {
      return (n = ia.day(n)).setMonth(0, 1), n
    },
    function(n, t) {
    ...
    (ia.years = ia.year.range),
    (ia.years.utc = ia.year.utc.range),
    (ia.day = On(
      function(n) {
        var t = new ua(2e3, 0)
    ...
    (ia.days = ia.day.range),
    (ia.days.utc = ia.day.utc.range),
    (ia.dayOfYear = function(n) {
      var t = ia.year(n)
      return Math.floor(
    ...
    [
      ...
      var e = (ia[n] = On(
        function(n) {
          return (
            (n = ia.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          )
        },
        function(n, t) {
        ...
        function(n) {
          var e = ia.year(n).getDay()
          return Math.floor((ia.dayOfYear(n) + ((e + t) % 7)) / 7) - (e !== t)
        }
      ))
      ;(ia[n + 's'] = e.range),
        (ia[n + 's'].utc = e.utc.range),
        (ia[n + 'OfYear'] = function(n) {
          var e = ia.year(n).getDay()
          return Math.floor((ia.dayOfYear(n) + ((e + t) % 7)) / 7)
        })
    }),
    (ia.week = ia.sunday),
    (ia.weeks = ia.sunday.range),
    (ia.weeks.utc = ia.sunday.utc.range),
    (ia.weekOfYear = ia.sundayOfYear)
  var aa = { '-': '', _: ' ', 0: '0' },
    la = /^\s*\d+/,
    ca = /^%/
  to.locale = function(n) {
    return { numberFormat: Un(n), timeFormat: In(n) }
  }
  var fa = to.locale({
    decimal: '.',
    thousands: ',',
  ...
  ;(to.format = fa.numberFormat),
    ...
    (ft.prototype = {
      ...
      add: function(n) {
        st(n, this.t, sa),
          st(sa.s, this.s, this),
          this.s ? (this.t += sa.t) : (this.s = sa.t)
      },
      reset: function() {
        this.s = this.t = 0
      },
  ...
  to.geo.stream = function(n, t) {
    n && ha.hasOwnProperty(n.type) ? ha[n.type](n, t) : ht(n, t)
  }
  var ha = {
  ...
  to.geo.area = function(n) {
    return (ga = 0), to.geo.stream(n, va), ga
  }
  var ga,
    da = new ft(),
    va = {
      ...
      lineEnd: _,
      polygonStart: function() {
        da.reset(), (va.lineStart = dt)
      },
      polygonEnd: function() {
        var n = 2 * da
        ;(ga += n < 0 ? 4 * Lo + n : n),
          (va.lineStart = va.lineEnd = va.point = _)
      },
    }
  ;(to.geo.bounds = (function() {
    function n(n, t) {
      x.push((M = [(f = n), (h = n)])), t < s && (s = t), t > p && (p = t)
    }
    function t(t, e) {
      var r = vt([t * Do, e * Do])
      if (y) {
        ...
        var o = t - g,
          ...
          c = u[0] * Po * l,
          d = so(o) > 180
        if (d ^ (l * g < c && c < l * t)) (v = u[1] * Po) > p && (p = v)
        else if (
          ((c = ((c + 360) % 360) - 180), d ^ (l * g < c && c < l * t))
        ) {
          var v = -u[1] * Po
          v < s && (s = v)
    ...
    return function(n) {
      ;(p = h = -(f = s = 1 / 0)), (x = []), to.geo.stream(n, _)
      var t = x.length
      if (t) {
        x.sort(l)
        for (var e = 1, r = [(g = x[0])]; e < t; ++e)
          c((u = x[e])[0], g) || c(u[1], g)
            ? (a(g[0], u[1]) > a(g[0], g[1]) && (g[1] = u[1]),
              a(u[0], g[1]) > a(g[0], g[1]) && (g[0] = u[0]))
            : r.push((g = u))
        for (
          var i, u, o = -1 / 0, e = 0, g = r[(t = r.length - 1)];
          e <= t;
          g = u, ++e
        )
          (u = r[e]),
    ...
    (to.geo.centroid = function(n) {
      ;(ya = ma = xa = Ma = _a = ba = wa = Sa = ka = Na = Ea = 0),
        to.geo.stream(n, Aa)
      var t = ka,
        e = Na,
        r = Ea,
      ...
      return i < zo &&
        ...
        (e = wa),
        (r = Sa),
        ma < Co && ((t = xa), (e = Ma), (r = _a)),
        (i = t * t + e * e + r * r) < zo)
        ? [NaN, NaN]
        : [Math.atan2(e, t) * Po, tn(r / Math.sqrt(i)) * Po]
    })
  var ya,
    ma,
    xa,
        ...
        (n.translate = function(t) {
          ...
          return (
            ...
            (r = o
              ...
              .clipExtent([
                [f - 0.425 * c + Co, s + 0.12 * c + Co],
                [f - 0.214 * c - Co, s + 0.234 * c - Co],
              ])
              .stream(l).point),
            (i = a
              .translate([f - 0.205 * c, s + 0.212 * c])
              .clipExtent([
                [f - 0.214 * c + Co, s + 0.166 * c + Co],
                [f - 0.115 * c - Co, s + 0.234 * c - Co],
              ])
              .stream(l).point),
            n
          )
  ...
  var La,
    ...
    ja = {
      ...
      polygonEnd: function() {
        ;(ja.lineStart = ja.lineEnd = ja.point = _), (La += so(qa / 2))
      },
    },
    Ua = {
      point: Bt,
    ...
    Fa = {
      ...
      polygonEnd: function() {
        ;(Fa.point = Gt), (Fa.lineStart = Kt), (Fa.lineEnd = Qt)
      },
    }
  ;(to.geo.path = function() {
    ...
    return (
      (n.area = function(n) {
        return (La = 0), to.geo.stream(n, i(ja)), La
      }),
      (n.centroid = function(n) {
        return (
          (xa = Ma = _a = ba = wa = Sa = ka = Na = Ea = 0),
          to.geo.stream(n, i(Fa)),
          Ea
            ? [ka / Ea, Na / Ea]
            : Sa
            ? [ba / Sa, wa / Sa]
    ...
    (to.geo.projection = oe),
    (to.geo.projectionMutator = ae),
    ((to.geo.equirectangular = function() {
      return oe(ce)
    }).raw = ce.invert = ce),
    (to.geo.rotation = function(n) {
      function t(t) {
        return (t = n(t[0] * Do, t[1] * Do)), (t[0] *= Po), (t[1] *= Po), t
      }
      return (
        (n = se((n[0] % 360) * Do, n[1] * Do, n.length > 2 ? n[2] * Do : 0)),
        (t.invert = function(t) {
          return (
            (t = n.invert(t[0] * Do, t[1] * Do)), (t[0] *= Po), (t[1] *= Po), t
          )
        }),
        t
      )
    ...
    (fe.invert = ce),
    (to.geo.circle = function() {
      function n() {
        var n = 'function' == typeof r ? r.apply(this, arguments) : r,
          t = se(-n[0] * Do, -n[1] * Do, 0).invert,
          i = []
        return (
          e(null, null, 1, {
            point: function(n, e) {
              i.push((n = t(n, e))), (n[0] *= Po), (n[1] *= Po)
            },
          }),
      ...
      return (
        ...
        (n.angle = function(r) {
          return arguments.length ? ((e = de((t = +r) * Do, i * Do)), n) : t
        }),
        (n.precision = function(r) {
          return arguments.length ? ((e = de(t * Do, (i = +r) * Do)), n) : i
        }),
        n.angle(90)
      )
    }),
    ...
    (to.geo.graticule = function() {
      ...
      function t() {
        return to
          .range(Math.ceil(u / v) * v, i, v)
          .map(h)
          .concat(to.range(Math.ceil(c / y) * y, l, y).map(p))
          .concat(
            to
      ...
      return (
        ...
        n
          .majorExtent([[-180, -90 + Co], [180, 90 - Co]])
          .minorExtent([[-180, -80 - Co], [180, 80 + Co]])
      )
    }),
    ...
    (to.geo.interpolate = function(n, t) {
      return _e(n[0] * Do, n[1] * Do, t[0] * Do, t[1] * Do)
    }),
    (to.geo.length = function(n) {
      return (Ha = 0), to.geo.stream(n, Oa), Ha
    })
  var Ha,
    Oa = {
      sphere: _,
  ...
  ;((to.geo.azimuthalEquidistant = function() {
    ...
    ((to.geo.conicConformal = function() {
      return Vt(Se)
    }).raw = Se),
    ((to.geo.conicEquidistant = function() {
      return Vt(ke)
    }).raw = ke)
  var Za = we(function(n) {
    return 1 / n
  }, Math.atan)
  ;((to.geo.gnomonic = function() {
    ...
    (Ne.invert = function(n, t) {
      return [n, 2 * Math.atan(Math.exp(t)) - Ro]
    }),
  ...
  ;((to.geo.stereographic = function() {
    ...
    (Ae.invert = function(n, t) {
      return [-t, 2 * Math.atan(Math.exp(n)) - Ro]
    }),
  ...
  var $a = (to.geom.polygon.prototype = [])
  ;($a.area = function() {
      ...
      insert: function(n, t) {
        ...
        for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (n = r))
              : (n === e.R && (ir(this, e), (e = (n = e).U)),
                (e.C = !1),
                (r.C = !0),
                ur(this, r))
            : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (n = r))
            : (n === e.L && (ur(this, e), (e = (n = e).U)),
              (e.C = !1),
              (r.C = !0),
              ir(this, r)),
            (e = n.U)
    ...
    (to.geom.voronoi = function(n) {
      ...
      function e(n) {
        return n.map(function(n, t) {
          return {
            x: Math.round(u(n, t) / Co) * Co,
            y: Math.round(o(n, t) / Co) * Co,
            i: t,
          }
        })
      }
  ...
  ;(to.geom.delaunay = function(n) {
    ...
    (to.geom.quadtree = function(n, t, e, r, i) {
      function u(n) {
          ...
          if (!isNaN(e) && !isNaN(r))
            if (n.leaf) {
              var l = n.x,
                f = n.y
              if (null != l)
                if (so(l - e) + so(f - r) < 0.01) c(n, t, e, r, i, u, o, a)
                else {
                  var s = n.point
        ...
        var w = y - d,
          S = m - v
        w > S ? (m = v + w) : (y = d + S)
        var k = { leaf: !0, nodes: [], point: null, x: null, y: null }
        if (
          ((k.add = function(n) {
            u(k, n, +x(n, ++p), +M(n, p), d, v, y, m)
          }),
          (k.visit = function(n) {
            hr(n, k, d, v, y, m)
          }),
    ...
    (to.interpolateRgb = gr),
    (to.interpolateObject = dr),
    (to.interpolateNumber = vr),
    (to.interpolateString = yr)
  var el = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
    rl = new RegExp(el.source, 'g')
  ;(to.interpolate = mr),
    (to.interpolators = [
      function(n, t) {
        var e = typeof t
        return ('string' === e
          ? Wo.has(t.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(t)
            ? gr
            : yr
          : t instanceof an
          ? gr
  ...
  ;(to.ease = function(n) {
    ...
    return (
      (e = ul.get(e) || il),
      (r = ol.get(r) || m),
      Mr(r(e.apply(null, eo.call(arguments, 1))))
    )
  }),
    (to.interpolateHcl = Tr),
    (to.interpolateHsl = Rr),
    (to.interpolateLab = Dr),
    (to.interpolateRound = Pr),
    (to.transform = function(n) {
  ...
  var al = { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 }
  ;(to.interpolateTransform = Xr),
    (to.layout = {}),
    (to.layout.bundle = function() {
      return function(n) {
        for (var t = [], e = -1, r = n.length; ++e < r; ) t.push(Wr(n[e]))
        return t
      }
    }),
    (to.layout.chord = function() {
      function n() {
        ...
        for (e = [], r = [], n = 0, h = -1; ++h < u; ) {
          ...
          d.push(c), y.push(to.range(u)), (n += c)
        }
        for (
          o &&
            v.sort(function(n, t) {
          ...
          ;(r[m] = { index: m, startAngle: s, endAngle: c, value: d[m] }),
            (c += f)
        }
        for (h = -1; ++h < u; )
          for (p = h - 1; ++p < u; ) {
    ...
    (to.layout.force = function() {
      ...
      function t(n) {
        ;(n.px = to.event.x), (n.py = to.event.y), l.resume()
      }
      var e,
        r,
        i,
      ...
      return (
        (l.tick = function() {
          ...
          for (r = 0; r < w; ++r)
            (h = (l = M[r]).source),
              (d = (m = (p = l.target).x - h.x) * m + (_ = p.y - h.y) * _) &&
                ((m *= d = (i * o[r] * ((d = Math.sqrt(d)) - u[r])) / d),
                (_ *= d),
                (p.x -=
                  m *
                  (y =
                ...
                (h.x += m * (y = 1 - y)),
                (h.y += _ * y))
          if ((y = i * v) && ((m = f[0] / 2), (_ = f[1] / 2), (r = -1), y))
            for (; ++r < b; )
              ((l = x[r]).x += (m - l.x) * y), (l.y += (_ - l.y) * y)
          if (g)
            for (ei((t = to.geom.quadtree(x)), i, a), r = -1; ++r < b; )
              (l = x[r]).fixed || t.visit(n(l))
          for (r = -1; ++r < b; )
            (l = x[r]).fixed
              ? ((l.x = l.px), (l.y = l.py))
              : ((l.x -= (l.px - (l.px = l.x)) * s),
        ...
        (l.chargeDistance = function(n) {
          return arguments.length ? ((d = n * n), l) : Math.sqrt(d)
        }),
        ...
        (l.start = function() {
          ...
          var t,
            ...
            s = f[0],
            d = f[1]
          for (t = 0; t < i; ++t) ((r = x[t]).index = t), (r.weight = 0)
          for (t = 0; t < c; ++t)
            'number' == typeof (r = M[t]).source && (r.source = x[r.source]),
              'number' == typeof r.target && (r.target = x[r.target]),
              ++r.source.weight,
              ++r.target.weight
          for (t = 0; t < i; ++t)
            (r = x[t]),
          ...
          if (((u = []), 'function' == typeof h))
            for (t = 0; t < c; ++t) u[t] = +h.call(this, M[t], t)
          else for (t = 0; t < c; ++t) u[t] = h
          if (((o = []), 'function' == typeof p))
            for (t = 0; t < c; ++t) o[t] = +p.call(this, M[t], t)
          else for (t = 0; t < c; ++t) o[t] = p
          if (((a = []), 'function' == typeof g))
            for (t = 0; t < i; ++t) a[t] = +g.call(this, x[t], t)
          else for (t = 0; t < i; ++t) a[t] = g
          return l.resume()
        }),
        (l.resume = function() {
          return l.alpha(0.1)
          ...
          if (
            (r ||
              (r = to.behavior
                .drag()
                .origin(m)
                .on('dragstart.force', Kr)
                .on('drag.force', t)
                .on('dragend.force', Qr)),
            !arguments.length)
          )
            return r
          this.on('mouseover.force', ni)
            .on('mouseout.force', ti)
            .call(r)
        }),
        to.rebind(l, c, 'on')
      )
  ...
  to.layout.stack = function() {
    function n(a, l) {
      ...
      var c = a.map(function(e, r) {
        ...
        s = e.call(n, f, l)
      ;(c = to.permute(c, s)), (f = to.permute(f, s))
      var h,
        p,
        g,
        d,
    ...
    return (
      ...
      (n.order = function(t) {
        return arguments.length
          ? ((e = 'function' == typeof t ? t : hl.get(t) || pi), n)
          : e
      }),
      (n.offset = function(t) {
        return arguments.length
          ? ((r = 'function' == typeof t ? t : pl.get(t) || gi), n)
          : r
      }),
      (n.x = function(t) {
        return arguments.length ? ((u = t), n) : u
  ...
  ;(to.layout.histogram = function() {
    function n(n, u) {
      for (
        ...
        ((o = l[u] = []).dx = s[u + 1] - (o.x = s[u])), (o.y = 0)
      if (p > 0)
        for (u = -1; ++u < h; )
          (a = c[u]) >= f[0] &&
            a <= f[1] &&
            (((o = l[to.bisect(s, a, 1, p) - 1]).y += g), o.push(n[u]))
      return l
    }
    var t = !0,
      e = Number,
    ...
    (to.layout.tree = function() {
      function n(n, r) {
        var u = M.call(this, n, r),
          o = t(u[0])
        return (N = o), e(o, 0), i(o), g(o, 0), m(o), u
      }
      function t(n) {
        var e = {
          t: n,
      ...
      function o(n, t, e) {
        for (
          ...
          var g = f(r),
            d = f(u)
          g <= d && null != (r = c(r)) && (i += r.mod),
            g >= d && null != (u = l(u)) && (o += u.mod)
        }
        null == r && null != u
          ? s(n, t, u, o)
      ...
      function v(n) {
        for (var t = 0, e = 0, r = 0; r < n.num_children; r++)
          (e += (t += n.children[r].shift) + n.children[r].change),
            (n.children[r].mod += e)
      }
      function y(n, t, e) {
      ...
      function m(n) {
        if (null != w) {
          ...
          var o = null == _ ? 0.5 : _(e.t, r.t) / 2,
            a = o - e.t.x,
            l = w[0] / (r.t.x + o + a),
            c = w[1] / (i.t.depth > 0 ? i.t.depth : 1)
          for (u = [n]; (t = u.pop()); ) {
            var f = t.t
            ;(f.x = (f.x + a) * l),
              (f.y = f.depth * c),
              k && ((f.x_size *= l), (f.y_size *= c)),
              t.children && (u = u.concat(t.children))
          }
        } else x(n, -n.t.x)
      }
      function x(n, t) {
        n.t.x += t
        for (var e = 0; e < n.num_children; ++e) x(n.children[e], t)
      }
      var M = to.layout
          .hierarchy()
          .sort(null)
      ...
      return (
        ...
        (u.padding = function(n) {
          function t(t) {
            ...
            return null == e
              ? Di(t)
              : Pi(t, 'number' == typeof e ? [e, e, e, e] : e)
          }
          function e(t) {
            return Pi(t, n)
          }
    ...
    (to.scale = {})
  var gl = { floor: m, ceil: m }
  to.scale.linear = function() {
    return Ii([0, 1], [0, 1], mr, !1)
  }
  var dl = { s: 1, g: 1, p: 1, r: 1, e: 1 }
    ...
    (to.svg.arc = function() {
      function n() {
        var n = Math.max(0, +e.apply(this, arguments)),
          ...
          f = o.apply(this, arguments) - Ro,
          s = a.apply(this, arguments) - Ro,
          h = Math.abs(s - f),
          p = f > s ? 0 : 1
        if ((c < n && ((g = c), (c = n), (n = g)), h >= To))
        ...
        if (
          ((y = (+l.apply(this, arguments) || 0) / 2) &&
            ((v =
              u === bl ? Math.sqrt(n * n + c * c) : +u.apply(this, arguments)),
            p || (E *= -1),
          ...
          ;(m = c * Math.cos(f + E)),
            ...
            (M = c * Math.cos(s - E)),
            (_ = c * Math.sin(s - E))
          var C = Math.abs(s - f - 2 * E) <= Lo ? 0 : 1
          if (E && (su(m, x, M, _) === p) ^ C) {
            var z = (f + s) / 2
            ;(m = c * Math.cos(z)), (x = c * Math.sin(z)), (M = _ = null)
          }
        } else m = x = 0
        if (n) {
          ;(b = n * Math.cos(s - N)),
            ...
            (S = n * Math.cos(f + N)),
            (k = n * Math.sin(f + N))
          var L = Math.abs(f - s + 2 * N) <= Lo ? 0 : 1
          if (N && (su(b, w, S, k) === 1 - p) ^ L) {
            var q = (f + s) / 2
            ;(b = n * Math.cos(q)), (w = n * Math.sin(q)), (S = k = null)
          }
        } else b = w = 0
        if (
          h > Co &&
          ...
          if (null != M) {
            var Y = hu(null == S ? [b, w] : [S, k], [m, x], c, T, p),
              I = hu([M, _], [b, w], c, T, p)
            g === T
              ? A.push(
                  'M',
                  ...
                  c,
                  ' 0 ',
                  (1 - p) ^ su(Y[1][0], Y[1][1], I[1][0], I[1][1]),
                  ',',
                  p,
                  ' ',
                  I[1],
              ...
              : A.push('M', Y[0], 'A', T, ',', T, ' 0 1,', d, ' ', I[0])
          } else A.push('M', m, ',', x)
          if (null != S) {
            var Z = hu([m, x], [S, k], n, -R, p),
              V = hu([b, w], null == M ? [m, x] : [M, _], n, -R, p)
            g === R
              ? A.push(
                  'L',
                  V[0],
              ...
              : A.push('L', V[0], 'A', R, ',', R, ' 0 0,', d, ' ', Z[0])
          } else A.push('L', b, ',', w)
        } else
          A.push('M', m, ',', x),
            null != M &&
              A.push('A', c, ',', c, ' 0 ', C, ',', p, ' ', M, ',', _),
            A.push('L', b, ',', w),
            null != S &&
      ...
      return (
        ...
        (n.padRadius = function(t) {
          return arguments.length ? ((u = t == bl ? bl : En(t)), n) : u
        }),
        (n.startAngle = function(t) {
        ...
        (n.centroid = function() {
          var n = (+e.apply(this, arguments) + +r.apply(this, arguments)) / 2,
            t = (+o.apply(this, arguments) + +a.apply(this, arguments)) / 2 - Ro
  ...
  ;(to.svg.line.radial = function() {
    ...
    (to.svg.diagonal.radial = function() {
      ...
      return (
        (n.projection = function(n) {
          return arguments.length ? e(Uu((t = n))) : t
        }),
        n
      )
    }),
    (to.svg.symbol = function() {
      function n(n, r) {
        return (El.get(t.call(this, n, r)) || Ou)(e.call(this, n, r))
      }
      var t = Hu,
        e = Fu
      return (
  ...
  to.svg.symbolTypes = El.keys()
  var Al = Math.sqrt(3),
    Cl = Math.tan(30 * Do)
  ;(_o.transition = function(n) {
    for (
      var t,
        e,
        r = zl || ++Rl,
        i = Xu(n),
        u = [],
        o = Ll || { time: Date.now(), ease: kr, delay: 0, duration: 250 },
        a = -1,
        l = this.length;
      ++a < l;
      ...
      for (var c = this[a], f = -1, s = c.length; ++f < s; )
        (e = c[f]) && $u(e, f, i, r, o), t.push(e)
    }
    return Iu(u, i, r)
  }),
    (_o.interrupt = function(n) {
      return this.each(null == n ? ql : Yu(Xu(n)))
    })
  var zl,
    Ll,
    ql = Yu(Xu()),
  ...
  ;(Tl.call = _o.call),
    ...
    (Tl.node = _o.node),
    (Tl.size = _o.size),
    (to.transition = function(n, t) {
      return n && n.transition
        ? zl
          ? n.transition(t)
          : n
        : to.selection().transition(n)
    }),
    (to.transition.prototype = Tl),
    ...
    (Tl.filter = function(n) {
      ...
      for (var u = 0, o = this.length; u < o; u++) {
        i.push((t = []))
        for (var a = 0, l = (e = this[u]).length; a < l; a++)
          (r = e[a]) && n.call(r, r.__data__, a, u) && t.push(r)
      }
      return Iu(i, this.namespace, this.id)
    }),
    ...
    (Tl.ease = function(n) {
      ...
      return arguments.length < 1
        ? this.node()[e][t].ease
        : ('function' != typeof n && (n = to.ease.apply(to, arguments)),
          I(this, function(r) {
            r[e][t].ease = n
          }))
    }),
    ...
    (Tl.each = function(n, t) {
      ...
      if (arguments.length < 2) {
        ...
        try {
          ;(zl = e),
            I(this, function(t, i, u) {
              ;(Ll = t[r][e]), n.call(t, t.__data__, i, u)
            })
        } finally {
          ;(Ll = i), (zl = u)
        }
        ...
        I(this, function(i) {
          var u = i[r][e]
          ;(u.event || (u.event = to.dispatch('start', 'end', 'interrupt'))).on(
            n,
            t
          )
        })
    ...
    (Tl.transition = function() {
      for (
        ...
        a.push((n = []))
        for (var f = 0, s = (t = this[l]).length; f < s; f++)
          (e = t[f]) &&
            $u(e, f, o, u, {
              time: (r = e[o][i]).time,
              ease: r.ease,
    ...
    (to.svg.axis = function() {
          ...
          if (
            ('bottom' === r || 'top' === r
              ? ((n = Bu),
                ...
                (S = 'x2'),
                (N = 'y2'),
                C.attr('dy', q < 0 ? '0em' : '.71em').style(
                  'text-anchor',
                  'middle'
                ),
                b.attr(
                  'd',
                  'M' + M[0] + ',' + q * u + 'V0H' + M[1] + 'V' + q * u
                ))
              : ((n = Wu),
                (w = 'y'),
                (k = 'x'),
                ...
                b.attr(
                  'd',
                  'M' + q * u + ',' + M[0] + 'H0V' + M[1] + 'H' + q * u
                )),
            E.attr(N, q * i),
            z.attr(k, q * x),
            A.attr(S, 0).attr(N, q * i),
            L.attr(w, 0).attr(k, q * x),
            s.rangeBand)
          ) {
            var T = s,
              R = T.rangeBand() / 2
      ...
      return (
        ...
        (n.orient = function(t) {
          return arguments.length ? ((r = t in Pl ? t + '' : Dl), n) : r
        }),
        (n.ticks = function() {
          return arguments.length ? ((a = ro(arguments)), n) : a
        }),
  ...
  to.svg.brush = function() {
    function n(t) {
      t.each(function() {
        ...
        var l,
          s = to.transition(t),
          h = to.transition(o)
        c && ((l = Ui(c)), h.attr('x', l[0]).attr('width', l[1] - l[0]), r(s)),
          f &&
            ((l = Ui(f)), h.attr('y', l[0]).attr('height', l[1] - l[0]), i(s)),
          e(s)
      })
    }
    function e(n) {
    ...
    function u() {
      function u() {
        32 == to.event.keyCode &&
          (C || ((x = null), (L[0] -= s[1]), (L[1] -= h[1]), (C = 2)), S())
      }
      function d() {
        32 == to.event.keyCode &&
          2 == C &&
      ...
      function y(n, t, e) {
        ...
        if (
          ...
          C
            ? (i = (r += f) + v)
            : (x && (f = Math.max(l, Math.min(c, 2 * x[e] - r))),
              f < r ? ((i = r), (r = f)) : (i = f)),
          d[0] != r || d[1] != i)
        )
      ...
      function m() {
        v(),
          ...
          to.select('body').style('cursor', null),
          q
      ...
      var x,
        ...
        q = to
          ...
          .on('keyup.brush', d)
      if (
        (to.event.changedTouches
          ? q.on('touchmove.brush', v).on('touchend.brush', m)
          : q.on('mousemove.brush', v).on('mouseup.brush', m),
        k
          .interrupt()
          .selectAll('*')
          .interrupt(),
        ...
        var T = +/w$/.test(N),
          R = +/^n/.test(N)
        ;(M = [s[1 - T] - L[0], h[1 - R] - L[1]]), (L[0] = s[T]), (L[1] = h[R])
      } else to.event.altKey && (x = L.slice())
      k
        .style('pointer-events', 'none')
        .selectAll('.resize')
        .style('display', null),
        to.select('body').style('cursor', b.style('cursor')),
        w({ type: 'brushstart' }),
        v()
    }
    var o,
    ...
    return (
      ...
      (n.x = function(t) {
        return arguments.length ? ((c = t), (d = Ul[(!c << 1) | !f]), n) : c
      }),
      (n.y = function(t) {
        return arguments.length ? ((f = t), (d = Ul[(!c << 1) | !f]), n) : f
      }),
      (n.clamp = function(t) {
        return arguments.length
          ? (c && f
  ...
  var jl = {
    ...
    Fl = (ia.format = fa.timeFormat),
    Hl = Fl.utc,
    Ol = Hl('%Y-%m-%dT%H:%M:%S.%LZ')
  ;(Fl.iso =
    ...
    (Ju.toString = Ol.toString),
    (ia.second = On(
      function(n) {
        return new ua(1e3 * Math.floor(n / 1e3))
      },
      function(n, t) {
    ...
    (ia.seconds = ia.second.range),
    (ia.seconds.utc = ia.second.utc.range),
    (ia.minute = On(
      function(n) {
        return new ua(6e4 * Math.floor(n / 6e4))
      },
      function(n, t) {
    ...
    (ia.minutes = ia.minute.range),
    (ia.minutes.utc = ia.minute.utc.range),
    (ia.hour = On(
      function(n) {
        var t = n.getTimezoneOffset() / 60
        return new ua(36e5 * (Math.floor(n / 36e5 - t) + t))
      },
      function(n, t) {
    ...
    (ia.hours = ia.hour.range),
    (ia.hours.utc = ia.hour.utc.range),
    (ia.month = On(
      function(n) {
        return (n = ia.day(n)).setDate(1), n
      },
      function(n, t) {
    ...
    (ia.months = ia.month.range),
    (ia.months.utc = ia.month.utc.range)
  var Yl = [
      1e3,
      5e3,
      15e3,
  ...
  ;(Il.year = ia.year),
    (ia.scale = function() {
      return Gu(to.scale.linear(), Il, Zl)
    })
  var Xl = Il.map(function(n) {
      return [n[0].utc, n[1]]
    }),
    $l = Hl.multi([
      [
  ...
  ;(Xl.year = ia.year.utc),
    (ia.scale.utc = function() {
      return Gu(to.scale.linear(), Xl, $l)
    }),
    ...
    (to.html = function(n, t) {
      return console.log('d3.html'), Cn(n, 'text/html', no, t)
    }),
    (to.xml = An(function(n) {
      return n.responseXML
    })),
    'function' == typeof define && define.amd
      ? ((this.d3 = to), define(to))
