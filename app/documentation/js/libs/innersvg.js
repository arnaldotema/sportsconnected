    ...
    var t = function(e, r) {
      ...
      if (3 == i)
        ...
        if ((r.push('<', e.tagName), e.hasAttributes()))
          for (var n = e.attributes, s = 0, o = n.length; s < o; ++s) {
            var a = n.item(s)
            r.push(' ', a.name, "='", a.value, "'")
          }
        if (e.hasChildNodes()) {
          r.push('>')
          for (var h = e.childNodes, s = 0, o = h.length; s < o; ++s)
            t(h.item(s), r)
          r.push('</', e.tagName, '>')
        } else r.push('/>')
      } else {
    ...
    Object.defineProperty(e.prototype, 'innerHTML', {
      ...
      set: function(e) {
        ...
        try {
          var t = new DOMParser()
          ;(t.async = !1),
            (sXML = "<svg xmlns='http://www.w3.org/2000/svg'>" + e + '</svg>')
          for (
            var r = t.parseFromString(sXML, 'text/xml').documentElement
              .firstChild;
            r;

          )
            this.appendChild(this.ownerDocument.importNode(r, !0)),
              (r = r.nextSibling)
        } catch (e) {
