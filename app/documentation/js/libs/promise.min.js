...
;(function(a) {
  ...
  b.prototype.done = function() {
    ...
    for (var a = 0; a < this._callbacks.length; a++)
      this._callbacks[a].apply(null, arguments)
    this._callbacks = []
  }
  function c(a) {
    var c = new b()
  ...
  function d(a, c) {
    ...
    if (a.length === 0) e.done.apply(e, c)
      ...
      a[0].apply(null, c).then(function() {
        a.splice(0, 1)
  ...
  function e(a) {
    ...
    if (typeof a === 'string') b = a
      ...
      var d = []
      for (var e in a) if (a.hasOwnProperty(e)) d.push(c(e) + '=' + c(a[e]))
      b = d.join('&')
    }
    return b
  }
  ...
  function g(a, c, d, g) {
    ...
    j.onreadystatechange = function() {
      ...
      if (j.readyState === 4) {
        var a =
          !j.status || ((j.status < 200 || j.status >= 300) && j.status !== 304)
