      ...
      function(t, e, o) {
        ...
        e.exports = {
          enable: function(t) {
            ...
            e ||
              ((e = document.createElementNS(n.svgNS, 'defs')),
              t.svg.appendChild(e))
          ...
          disable: function(t) {
            t.controlIcons &&
              (t.controlIcons.parentNode.removeChild(t.controlIcons),
              (t.controlIcons = null))
          },
        }
      },
      ...
      function(t, e, o) {
        ...
        ;(s.prototype.init = function(t, e) {
          ;(this.viewport = t),
            ...
            (this.requestAnimationFrame = i.createRequestAnimationFrame(
          ...
          (s.prototype.cacheViewBox = function() {
            ...
            if (t) {
              ...
              ;(this.activeState.zoom = o),
                (this.activeState.x =
                  (this.options.width - this.viewBox.width * o) / 2),
                (this.activeState.y =
                  (this.options.height - this.viewBox.height * o) / 2),
          ...
          (s.prototype.processCTM = function() {
            ...
            if (this.options.center) {
              var o =
                  0.5 *
                  (this.options.width -
                    (this.viewBox.width + 2 * this.viewBox.x) * t.a),
                n =
                  0.5 *
                  (this.options.height -
                    (this.viewBox.height + 2 * this.viewBox.y) * t.a)
              ;(t.e = o), (t.f = n)
            }
            return (
              (this.originalState.zoom = t.a),
              ...
              if (
                (e &&
                  (this.options.beforeZoom(
                    ...
                    ? ((t.a = t.d = this.activeState.zoom), (e = !1))
                    : (this.updateCache(t),
                ...
                n === !1
                  ...
                  : i.isObject(n) &&
                    (n.x === !1
                      ? ((t.e = this.getPan().x), (s = !0))
                      : i.isNumber(n.x) && (t.e = n.x),
                    n.y === !1
                      ? ((t.f = this.getPan().y), (r = !0))
                      : i.isNumber(n.y) && (t.f = n.y)),
                  (s && r) || !this.isPanDifferent(t)
                    ? (o = !1)
                    : (this.updateCache(t), this.options.onPan(this.getPan()))
              }
          ...
          (s.prototype.updateCTM = function() {
            var t = this.getCTM()
            n.setCTM(this.viewport, t, this.defs),
              (this.pendingUpdate = !1),
              this.options.onUpdatedCTM && this.options.onUpdatedCTM(t)
          }),
      ...
      function(t, e, o) {
        ...
        ;(l.prototype.init = function(t, e) {
          ...
          ;(this.width = n.width),
            ...
            (this.viewport = a(
              r.getOrCreateViewport(this.svg, this.options.viewportSelector),
              {
                svg: this.svg,
                width: this.width,
                height: this.height,
                ...
                beforeZoom: function(t, e) {
                  if (o.viewport && o.options.beforeZoom)
                    return o.options.beforeZoom(t, e)
                },
                onZoom: function(t) {
                ...
                beforePan: function(t, e) {
                  if (o.viewport && o.options.beforePan)
                    return o.options.beforePan(t, e)
                },
                onPan: function(t) {
                ...
                onUpdatedCTM: function(t) {
                  if (o.viewport && o.options.onUpdatedCTM)
                    return o.options.onUpdatedCTM(t)
                },
              }
            ))
          ...
          l.setBeforeZoom(this.options.beforeZoom),
            ...
            l.setOnUpdatedCTM(this.options.onUpdatedCTM),
            ...
            if (
              ...
              if (o && o.length)
                for (var n = o.length - 1; n >= 0; n--)
                  this.eventListeners.hasOwnProperty(o[n]) &&
                    delete this.eventListeners[o[n]]
            }
            ...
            if (this.options.zoomEnabled && 'none' === this.state) {
              ...
              ;(this.lastMouseWheelEventTime = Date.now()),
                'deltaMode' in t &&
                  0 === t.deltaMode &&
                  t.wheelDelta &&
                  (e = 0 === t.deltaY ? 0 : Math.abs(t.wheelDelta) / t.deltaY),
                (e =
                  -0.3 < e && e < 0.3
                    ? e
                    : ((e > 0 ? 1 : -1) * Math.log(Math.abs(e) + 10)) / n)
          ...
          (l.prototype.zoomAtPoint = function(t, e, o) {
            ...
            o
              ? ((t = Math.max(
                  this.options.minZoom * n.zoom,
                  Math.min(this.options.maxZoom * n.zoom, t)
                )),
                (t /= this.getZoom()))
              : this.getZoom() * t < this.options.minZoom * n.zoom
              ? (t = (this.options.minZoom * n.zoom) / this.getZoom())
              : this.getZoom() * t > this.options.maxZoom * n.zoom &&
                (t = (this.options.maxZoom * n.zoom) / this.getZoom())
          ...
          (l.prototype.zoom = function(t, e) {
            this.zoomAtPoint(
              t,
              r.getSvgCenterPoint(this.svg, this.width, this.height),
              e
            )
          }),
          ...
          (l.prototype.publicZoomAtPoint = function(t, e, o) {
            if (
              (o && (t = this.computeFromRelativeZoom(t)),
          ...
          (l.prototype.handleMouseDown = function(t, e) {
            this.options.preventMouseEventsDefault &&
              ...
              this.options.dblClickZoomEnabled && s.isDblClick(t, e)
          ...
          (l.prototype.center = function() {
            var t = this.viewport.getViewBox(),
              e = 0.5 * (this.width - (t.width + 2 * t.x) * this.getZoom()),
              o = 0.5 * (this.height - (t.height + 2 * t.y) * this.getZoom())
          ...
          (l.prototype.destroy = function() {
            ...
            for (var e in this.eventListeners)
              (
                this.options.eventsListenerElement || this.svg
              ).removeEventListener(e, this.eventListeners[e], !1)
              ...
              this.publicInstance ||
                (this.publicInstance = this.pi = {
                  ...
                  enableControlIcons: function() {
                    return (
                      t.options.controlIconsEnabled ||
                        ((t.options.controlIconsEnabled = !0), i.enable(t)),
                      t.pi
                    )
                  },
                  disableControlIcons: function() {
                    return (
                      t.options.controlIconsEnabled &&
                        ((t.options.controlIconsEnabled = !1), i.disable(t)),
                      t.pi
                    )
                  },
                  ...
                  zoomOut: function() {
                    return (
                      this.zoomBy(1 / (1 + t.options.zoomScaleSensitivity)),
                      t.pi
                    )
                  },
                  getZoom: function() {
        ...
        var h = [],
          c = function(t, e) {
            ...
            for (var n = h.length - 1; n >= 0; n--)
              if (h[n].svg === o) return h[n].instance.getPublicInstance()
            return (
              h.push({ svg: o, instance: new l(o, e) }),
          ...
          (e.exports = {
            ...
            getOrCreateViewport: function(t, e) {
              ...
              if (((o = n.isElement(e) ? e : t.querySelector(e)), !o)) {
                ...
                1 === i.length &&
                  'g' === i[0].nodeName &&
                  null === i[0].getAttribute('transform') &&
                  (o = i[0])
              }
              if (!o) {
                var s =
                ...
                if (r && r.length > 0)
                  for (var a = r.length; a > 0; a--)
                    'defs' !== r[r.length - a].nodeName &&
                      o.appendChild(r[r.length - a])
                t.appendChild(o)
              }
              var l = []
              return (
                o.getAttribute('class') &&
                  (l = o.getAttribute('class').split(' ')),
                ~l.indexOf('svg-pan-zoom_viewport') ||
                  (l.push('svg-pan-zoom_viewport'),
            ...
            setupSvgAttributes: function(t) {
              if (
                (t.setAttribute('xmlns', this.svgNS),
                t.setAttributeNS(this.xmlnsNS, 'xmlns:xlink', this.xlinkNS),
                t.setAttributeNS(this.xmlnsNS, 'xmlns:ev', this.evNS),
                null !== t.parentNode)
              ) {
                var e = t.getAttribute('style') || ''
                e.toLowerCase().indexOf('overflow') === -1 &&
                  t.setAttribute('style', 'overflow: hidden; ' + e)
              }
            },
            internetExplorerRedisplayInterval: 300,
            refreshDefsGlobal: n.throttle(function() {
              for (
                var t = document.querySelectorAll('defs'), e = t.length, o = 0;
                o < e;
                o++
              ) {
                var n = t[o]
            ...
            setCTM: function(t, e, o) {
              ...
              t.setAttributeNS(null, 'transform', s),
                'transform' in t.style
                  ? (t.style.transform = s)
                  : '-ms-transform' in t.style
                  ? (t.style['-ms-transform'] = s)
                  : '-webkit-transform' in t.style &&
                    (t.style['-webkit-transform'] = s),
                'ie' === i &&
                  o &&
        ...
        e.exports = (function() {
          function t(t, e, o) {
            var n = function(t) {
              ...
              return (
                'mousewheel' == u
                  ? ((o.deltaY = -0.025 * t.wheelDelta),
                    t.wheelDeltaX && (o.deltaX = -0.025 * t.wheelDeltaX))
                  : (o.deltaY = t.detail),
                e(o)
              )
            }
            return c.push({ element: t, fn: n, capture: o }), n
          }
          function e(t, e) {
          ...
          function i(t, n, i, s) {
            var r
            ;(r = 'wheel' === u ? i : e(t, s)), t[l](h + n, r, s || !1), o(t, s)
          }
          function s(t, e, o) {
            n(t, u, e, o),
          ...
          return (
            window.addEventListener
              ? ((a = 'addEventListener'), (l = 'removeEventListener'))
              : ((a = 'attachEvent'), (l = 'detachEvent'), (h = 'on')),
            (u =
      ...
      function(t, e, o) {
        ...
        e.exports = {
          ...
          getSvg: function(t) {
            ...
            if ('svg' === e.tagName.toLowerCase()) o = e
              ...
              if ('embed' !== e.tagName.toLowerCase())
                throw 'img' === e.tagName.toLowerCase()
                  ? new Error(
          ...
          mouseAndTouchNormalize: function(t, e) {
            if (void 0 === t.clientX || null === t.clientX)
              if (
                ((t.clientX = 0),
                (t.clientY = 0),
                void 0 !== t.touches && t.touches.length)
              ) {
                if (void 0 !== t.touches[0].clientX)
                  (t.clientX = t.touches[0].clientX),
                    (t.clientY = t.touches[0].clientY)
                else if (void 0 !== t.touches[0].pageX) {
                  var o = e.getBoundingClientRect()
                  ;(t.clientX = t.touches[0].pageX - o.left),
                    (t.clientY = t.touches[0].pageY - o.top)
                }
              } else
                void 0 !== t.originalEvent &&
                  void 0 !== t.originalEvent.clientX &&
              ...
              return (
                ...
                c <= 0 || c > e
                  ? (clearTimeout(a),
                    ...
                    (s = t.apply(n, i)),
                    a || (n = i = null))
                  : a || o.trailing === !1 || (a = setTimeout(u, c)),
                s
              )
            }
          },
          createRequestAnimationFrame: function(t) {
            var e = null
            return (
              'auto' !== t && t < 60 && t > 1 && (e = Math.floor(1e3 / t)),
