!(function() {
  var t,
    ...
    z = function(e) {
      var t = new z.Builder()
      return (
        t.pipeline.add(z.trimmer, z.stopWordFilter, z.stemmer),
        t.searchPipeline.add(z.stemmer),
        e.call(t, t),
        t.build()
      )
    }
  ;(z.version = '2.3.2'),
    ...
    (z.FieldRef.joiner = '/'),
    (z.FieldRef.fromString = function(e) {
    ...
    (z.FieldRef.prototype.toString = function() {
      return (
        null == this._stringValue &&
          (this._stringValue =
            this.fieldName + z.FieldRef.joiner + this.docRef),
        this._stringValue
      )
    }),
    (z.Set = function(e) {
    ...
    (z.Set.prototype.union = function(e) {
      return e === z.Set.complete
        ? z.Set.complete
        : e === z.Set.empty
        ? this
        : new z.Set(Object.keys(this.elements).concat(Object.keys(e.elements)))
    }),
    (z.idf = function(e, t) {
      var r = 0
    ...
    (z.tokenizer = function(e, t) {
      ...
      if (Array.isArray(e))
        return e.map(function(e) {
          return new z.Token(
            z.utils.asString(e).toLowerCase(),
            z.utils.clone(t)
          )
        })
      for (
        ...
        if (r.charAt(s).match(z.tokenizer.separator) || s == i) {
          if (0 < a) {
            ...
            ;(u.position = [o, a]),
              (u.index = n.length),
              n.push(new z.Token(r.slice(o, s), u))
          }
          o = s + 1
        }
      }
    ...
    (z.tokenizer.separator = /[\s\-]+/),
    (z.Pipeline = function() {
      this._stack = []
    }),
    (z.Pipeline.registeredFunctions = Object.create(null)),
    (z.Pipeline.registerFunction = function(e, t) {
      t in this.registeredFunctions &&
        ...
        (e.label = t),
        (z.Pipeline.registeredFunctions[e.label] = e)
    }),
    ...
    (z.Pipeline.prototype.handleProxy = function(e) {
    ...
    (v = /.$/),
    (w = /(at|bl|iz)$/),
    (Q = new RegExp('([^aeiouylsz])\\1$')),
    (k = new RegExp('^' + r + e + '[^aeiouwxy]$')),
    (S = /^(.+?[^aeiou])y$/),
    ...
    (i = function(e) {
      ...
      ;(n = T).test(e) &&
        ...
        (s = f),
        (o = I),
        ((n = d).test(t) || (s.test(t) && !o.test(t))) && (e = t))
      return (
        (s = d),
        (n = O).test(e) && s.test(e) && ((n = v), (e = e.replace(n, ''))),
    ...
    (z.generateStopWordFilter = function(e) {
    ...
    (z.TokenSet = function() {
      ;(this.final = !1),
        (this.edges = {}),
        (this.id = z.TokenSet._nextId),
        (z.TokenSet._nextId += 1)
    }),
    (z.TokenSet._nextId = 1),
    (z.TokenSet.fromArray = function(e) {
      for (var t = new z.TokenSet.Builder(), r = 0, i = e.length; r < i; r++)
        t.insert(e[r])
      return t.finish(), t.root
    }),
    (z.TokenSet.fromClause = function(e) {
      return 'editDistance' in e
        ? z.TokenSet.fromFuzzyString(e.term, e.editDistance)
        : z.TokenSet.fromString(e.term)
    }),
    (z.TokenSet.fromFuzzyString = function(e, t) {
      for (
        var r = new z.TokenSet(), i = [{ node: r, editsRemaining: t, str: e }];
        i.length;
        ...
        var n,
          ...
          a = i.pop()
        if (0 < a.str.length)
          (s = a.str.charAt(0)) in a.node.edges
            ? (n = a.node.edges[s])
            : ((n = new z.TokenSet()), (a.node.edges[s] = n)),
            1 == a.str.length
              ? (n.final = !0)
              : i.push({
                  node: n,
        ...
        if (0 < a.editsRemaining && 1 < a.str.length)
          (s = a.str.charAt(1)) in a.node.edges
            ? (o = a.node.edges[s])
            : ((o = new z.TokenSet()), (a.node.edges[s] = o)),
            a.str.length <= 2
              ? (o.final = !0)
              : i.push({
                  node: o,
        ...
        if (
          (0 < a.editsRemaining && 1 == a.str.length && (a.node.final = !0),
          0 < a.editsRemaining && 1 <= a.str.length)
        ) {
        ...
        if (0 < a.editsRemaining && 1 < a.str.length) {
          ...
          d in a.node.edges
            ? (c = a.node.edges[d])
            : ((c = new z.TokenSet()), (a.node.edges[d] = c)),
            1 == a.str.length
              ? (c.final = !0)
              : i.push({
                  node: c,
    ...
    (z.TokenSet.fromString = function(e) {
      for (
        var t = new z.TokenSet(), r = t, i = !1, n = 0, s = e.length;
        n < s;
        n++
      ) {
        var o = e[n],
          a = n == s - 1
        if ('*' == o) (i = !0), ((t.edges[o] = t).final = a)
        else {
          var u = new z.TokenSet()
          ;(u.final = a), (t.edges[o] = u), (t = u), i && (t.edges['*'] = r)
        }
      }
      return r
    }),
          ...
          for (var l = n[u], c = 0; c < a; c++) {
            ...
            if (h == l || '*' == l) {
              ...
              h in r.output.edges
                ...
                : (((y = new z.TokenSet()).final = p), (r.output.edges[h] = y)),
    ...
    (z.Index.prototype.query = function(e) {
          ...
          for (var m = 0; m < p.length; m++) {
            ...
            for (y = 0; y < u.fields.length; y++) {
              var w = x[(R = u.fields[y])],
                ...
                S = new z.Set(Q)
              if (
                (u.presence == z.Query.presence.REQUIRED &&
                  ((c = c.union(S)),
                  void 0 === s[R] && (s[R] = z.Set.complete)),
                u.presence != z.Query.presence.PROHIBITED)
              ) {
                if (
                  ...
                  for (var E = 0; E < Q.length; E++) {
                    var L,
                      ...
                      T = w[b]
                    void 0 === (L = r[P])
                      ? (r[P] = new z.MatchData(g, R, T))
                      : L.add(g, R, T)
                  }
                  n[k] = !0
                }
              } else
                void 0 === o[R] && (o[R] = z.Set.empty), (o[R] = o[R].union(S))
            }
          }
        }
      ...
      for (a = 0; a < this.fields.length; a++) {
        var R
        s[(R = this.fields[a])] && (O = O.intersect(s[R])),
          o[R] && (I = I.union(o[R]))
      }
      var F = Object.keys(r),
        C = [],
      ...
      if (t.isNegated()) {
        ...
        for (a = 0; a < F.length; a++) {
          P = F[a]
          var _ = z.FieldRef.fromString(P)
          r[P] = new z.MatchData()
        }
      }
      for (a = 0; a < F.length; a++) {
        var j = (_ = z.FieldRef.fromString(F[a])).docRef
        if (O.contains(j) && !I.contains(j)) {
          var D,
            A = this.fieldVectors[_],
            B = i[_.fieldName].similarity(A)
          if (void 0 !== (D = N[j])) (D.score += B), D.matchData.combine(r[_])
          else {
            var V = { ref: j, score: B, matchData: r[_] }
            ;(N[j] = V), C.push(V)
          }
        }
      }
    ...
    (z.Builder = function() {
      ;(this._ref = 'id'),
        ...
        (this.fieldLengths = {}),
        (this.tokenizer = z.tokenizer),
        (this.pipeline = new z.Pipeline()),
        (this.searchPipeline = new z.Pipeline()),
    ...
    (z.Builder.prototype.createFieldVectors = function() {
      for (
        ...
        for (
          var s = z.FieldRef.fromString(t[n]),
            o = s.fieldName,
          ...
          void 0 === i[x]
            ? ((y = z.idf(this.invertedIndex[x], this.documentCount)),
              (i[x] = y))
            : (y = i[x]),
            (m =
              (y * ((this._k1 + 1) * v)) /
    ...
    (z.Builder.prototype.createTokenSet = function() {
      this.tokenSet = z.TokenSet.fromArray(
    ...
    (z.Query.wildcard = new String('*')),
    (z.Query.wildcard.NONE = 0),
    (z.Query.wildcard.LEADING = 1),
    (z.Query.wildcard.TRAILING = 2),
    (z.Query.presence = { OPTIONAL: 1, REQUIRED: 2, PROHIBITED: 3 }),
    (z.Query.prototype.clause = function(e) {
      return (
        ...
        'wildcard' in e || (e.wildcard = z.Query.wildcard.NONE),
        e.wildcard & z.Query.wildcard.LEADING &&
          e.term.charAt(0) != z.Query.wildcard &&
          (e.term = '*' + e.term),
        e.wildcard & z.Query.wildcard.TRAILING &&
          e.term.slice(-1) != z.Query.wildcard &&
          (e.term = e.term + '*'),
        'presence' in e || (e.presence = z.Query.presence.OPTIONAL),
        this.clauses.push(e),
        this
      )
    }),
    ...
    (z.QueryParseError.prototype = new Error()),
    (z.QueryLexer = function(e) {
      ;(this.lexemes = []),
        (this.str = e),
        (this.length = e.length),
        (this.pos = 0),
    ...
    (z.QueryLexer.prototype.handleProxy = function() {
    ...
    (z.QueryLexer.EOS = 'EOS'),
    (z.QueryLexer.FIELD = 'FIELD'),
    (z.QueryLexer.TERM = 'TERM'),
    (z.QueryLexer.EDIT_DISTANCE = 'EDIT_DISTANCE'),
    (z.QueryLexer.BOOST = 'BOOST'),
    (z.QueryLexer.PRESENCE = 'PRESENCE'),
    (z.QueryLexer.lexField = function(e) {
      return (
        e.backup(), e.emit(z.QueryLexer.FIELD), e.ignore(), z.QueryLexer.lexText
      )
    }),
    (z.QueryLexer.lexTerm = function(e) {
      if (
        (1 < e.width() && (e.backup(), e.emit(z.QueryLexer.TERM)),
        e.ignore(),
        e.more())
      )
        return z.QueryLexer.lexText
    }),
    (z.QueryLexer.lexEditDistance = function(e) {
      return (
        e.ignore(),
        e.acceptDigitRun(),
        e.emit(z.QueryLexer.EDIT_DISTANCE),
        z.QueryLexer.lexText
      )
    }),
    ...
    (z.QueryLexer.termSeparator = z.tokenizer.separator),
    (z.QueryLexer.lexText = function(e) {
      for (;;) {
        var t = e.next()
        ...
        if (92 != t.charCodeAt(0)) {
          ...
          if ('+' == t && 1 === e.width())
            return e.emit(z.QueryLexer.PRESENCE), z.QueryLexer.lexText
          if ('-' == t && 1 === e.width())
            return e.emit(z.QueryLexer.PRESENCE), z.QueryLexer.lexText
      ...
      if (null != t)
        switch (t.type) {
          ...
          default:
            ...
            throw (1 <= t.str.length && (r += " with value '" + t.str + "'"),
            new z.QueryParseError(r, t.start, t.end))
        }
    }),
