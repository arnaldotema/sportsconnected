  ...
  i.prototype = {
      ...
      return void 0 === e
        ...
        : ((this.options.btnClass = e),
          void this.$elementFilestyle
            ...
            .attr({
              class:
                'btn ' + this.options.btnClass + ' btn-' + this.options.size,
            }))
    },
    badge: function(e) {
      if (e === !0) {
    ...
    constructor: function() {
      var i = this,
        ...
        l = ''
      ;('' !== s && s) ||
        ((s = 'filestyle-' + t), i.$element.attr({ id: s }), t++),
        (l =
          ...
          '" ' +
          (i.options.disabled || i.$element.attr('disabled')
            ? ' disabled="true"'
            : '') +
          '>' +
          i.htmlIcon() +
          ...
          i.options.text +
          '</span></label></span>'),
        (n = i.options.buttonBefore ? l + i.htmlInput() : i.htmlInput() + l),
        ...
        i.$elementFilestyle
          ...
          .attr('tabindex', '0')
          .keypress(function(e) {
            return 13 === e.keyCode || 32 === e.charCode
              ? (i.$elementFilestyle.find('label').click(), !1)
              : void 0
          }),
        i.$element
        ...
        i.$elementFilestyle
          .find(i.options.buttonBefore ? 'label' : ':input')
          .css({
        ...
        (i.options.disabled || i.$element.attr('disabled')) &&
          (i.$element.attr('disabled', 'true'),
          i.options.disabled
            ? i.$elementFilestyle.find('label').css('opacity', '0.65')
            : i.$elementFilestyle.find('label').css('opacity', '1')),
        ...
        e(document)
          .on('dragover', function(t) {
            t.preventDefault(),
              t.stopPropagation(),
              i.options.dragdrop && e('[name="filedrag"]').css('z-index', '9')
          })
          .on('drop', function(t) {
            t.preventDefault(),
              t.stopPropagation(),
              i.options.dragdrop && e('[name="filedrag"]').css('z-index', '-1')
          }),
        i.$elementFilestyle
          .find('[name="filedrag"]')
          ...
          .on('drop', function(t) {
            if (
              ...
              t.preventDefault(),
                t.stopPropagation(),
                (i.$element[0].files = t.originalEvent.dataTransfer.files)
              ...
              i.options.badge
                ? 0 == i.$elementFilestyle.find('.badge').length
                  ...
                  : 0 == n.length
                  ? i.$elementFilestyle.find('.badge').remove()
                  : i.$elementFilestyle.find('.badge').html(n.length)
                : i.$elementFilestyle.find('.badge').remove(),
    ...
    var s = '',
      l = this.each(function() {
        if ('file' === e(this).attr('type')) {
          ...
          o || (l.data('filestyle', (o = new i(this, a))), o.constructor()),
            'string' == typeof t && (s = o[t](n))
        }
      })
