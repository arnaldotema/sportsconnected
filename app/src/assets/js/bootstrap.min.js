  ...
  +(function(t) {
        ...
        t(s).each(function() {
          ...
          i.hasClass('open') &&
            ((n &&
              ...
              (i.trigger((n = t.Event('hide.bs.dropdown', s))),
    ...
    function a(e) {
      return this.each(function() {
        ...
        a || n.data('bs.dropdown', (a = new o(this))),
      ...
      (o.prototype.toggle = function(a) {
        ...
        if (!i.is('.disabled, :disabled')) {
          ...
          if ((n(), !o)) {
            ...
            if (
              (s.trigger((a = t.Event('show.bs.dropdown', r))),
        ...
        if (
          ...
          if (
            ...
            if ((!o && 27 != n.which) || (o && 27 == n.which))
              return (
                27 == n.which && i.find(s).trigger('focus'), a.trigger('click')
              )
            var r = ' li:not(.disabled):visible a',
              l = i.find('.dropdown-menu' + r)
            if (l.length) {
    ...
    function n(e) {
      return this.each(function() {
        var n = t(this),
          ...
          s = t.extend({}, a.DEFAULTS, n.data(), 'object' == typeof e && e)
        !i && s.toggle && /show|hide/.test(e) && (s.toggle = !1),
