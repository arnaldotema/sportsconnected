...
export class EditUserInfoComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.feet = ["Esquerdo", "Direito", "Ambos"];
    this.cities = [
      "Lisboa",
      "Setúbal",
      "Praia",
    ...
    this.validation_messages = {
      ...
      gender: [{ type: "required", message: "Insere o teu género." }],
      birthday: [
        {
          type: "required",
          message: "Por favor, insere a tua data de nascimento"
        }
      ]
    };
  ...
  createForms() {
    ...
    this.userDetailsForm = this.fb.group({
      ...
      birthday: [
        this.viewModel.current_season.personal_info.date_of_birth,
        Validators.required
      ],
      gender: new FormControl(this.genders[0], Validators.required),
      height: [
        this.viewModel.current_season.personal_info.height,
        Validators.required
      ],
      weight: [
        this.viewModel.current_season.personal_info.weight,
        Validators.required
      ],
  ...
  save() {
    ...
    this.userInfoService
      .editUserInfo(this.viewModel.current_season, this.avatar)
      .subscribe(res => {
        this.authenticationService.setSessionAvatar(
          res["personal_info"].avatar + "?random=" + _make_random_text()
        );
  ...
  changedInput(inputType, event, isMatch) {
    ...
    } else this.viewModel[inputType] = value;
  }
