...
export class GenericUserService {
  ...
  mockUserInfo = [
    {
      ...
      type: "player",
      avatar:
        "https://e3.365dm.com/18/07/1096x616/skynews-cristiano-ronaldo-football_4358475.jpg?20180710164507",
      user_id: "1",
      personal_info: {
        name: "Cristiano Ronaldo",
        age: 22,
  ...
  globalSearch(
    query: string,
    type: string
  ): Observable<SearchEntityViewmodel[]> {
    let body = {
      item: type,
      query: query
    };
