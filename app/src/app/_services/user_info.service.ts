...
export class UserInfoService {
  mockUserInfo: any = {
    ...
    current_season: {
      ...
      personal_info: {
        ...
        number: "12",
        avatar:
          "https://connectnigeria.com/articles/wp-content/uploads/2017/12/Arsenal-legend-Thierry-Henry-624927.jpg",
      ...
      matches: [
        {
          ...
          competition_season: {
            ...
            avatar:
              "http://www.zerozero.pt/img/logos/edicoes/87509_imgbank_.png"
          },
          home_team: {
            id: "1",
            team_id: "1",
  ...
  mockTeamPlayer: TeamPlayer = {
    ...
    avatar:
      "https://3.bp.blogspot.com/-kQx3Kcg4wNI/Wv22ovgGofI/AAAAAAAAMtQ/4BUXZPOVo0coGETrtwwLhurNSslJlCYTwCLcBGAs/s1600/1%2BA%2Bmelhor%2B001.jpeg",
    positions: ["Avançado"],
    height: 165,
    weight: 55,
    foot: "Direito",
  ...
  getUserInfo(id: string): Observable<UserInfoViewModel> {
    ...
    if (this.testing || id == "-1") {
      ...
      return this.http
        .get<UserInfoViewModel>("/api/players/" + id, this.requestOptions)
        .pipe(
          tap(data => {
  ...
  getTeamPlayer(team_id: string, id: string): Observable<TeamPlayer> {
    if (this.testing || id == "-1") return of(this.mockTeamPlayer);

    return this.http
      .get<TeamPlayer>(
        "api/teams/" + team_id + "/player/" + id,
        this.requestOptions
      )
      .pipe(
        tap(data => {
  ...
  createRecommendation(
    ...
    return this.http
      .post<TeamPlayer>(
        "api/players/" + user_info_id + "/recommendations",
        { recommendation: recommendation },
        this.requestOptions
      )
      .pipe(
  ...
  voteForSkill(
    ...
    return this.http
      .post<any>(
        "api/players/" + user_info_id + "/skills",
        { skill_name: skillName, author_user_id: author_user_id },
        this.requestOptions
      )
      .pipe(
        tap(data => {
  ...
  follow(user_info_id: string): Observable<boolean> {
    ...
    let author_user_info_id = this.authenticationService.getSessionUser()
      .profile_id;

    return this.http
      .post<boolean>(
        "api/players/" + user_info_id + "/followers",
        { author_user_info_id: author_user_info_id },
        this.requestOptions
      )
      .pipe(
        tap(data => {
  ...
  unfollow(user_info_id: string): Observable<boolean> {
    ...
    return this.http
      .delete<boolean>(
        "api/players/" + user_info_id + "/followers/" + author_user_info_id,
        this.requestOptions
      )
      .pipe(
        tap(data => {
  ...
  editUserInfo(user_info_season: UserInfoSeason, avatar: File) {
    ...
    formData.append(
      "personal_info",
      JSON.stringify(user_info_season.personal_info)
    );
    formData.append("avatar", avatar, "avatar");

    return this.http
      .put<UserInfoSeason>(
        "/api/players/" + user_info_season._id,
        formData,
        this.requestOptionsMultipart
      )
      .pipe(
