module.exports = {
  ...
  baseUris: {
    // COMPETITIONS
    ALL_COMPETITIONS:
      "http://www.zerozero.pt/compet.php?continente=0&mod=1&gen=0&esc=0&stats=0&idpais=1",
    COMPETITION:
    ...
    COMPETITION_EDITION_MATCHES:
      "http://www.zerozero.pt/edition_matches.php?id={edition_id}&page={page}",
    // TEAMS
    TEAM_INFO:
      "http://www.zerozero.pt/equipa.php?id={team_id}&epoca_id={season_id}",
    TEAM_MATCHES:
      "http://www.zerozero.pt/team_matches.php?id={team_id}&epoca_id={season_id}",
    //PLAYERS
