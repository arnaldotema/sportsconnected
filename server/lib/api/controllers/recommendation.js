...
exports.search = function(req, res) {
  ...
  FootballRecommendation.find(query)
    ...
    .exec(function(err, recommendations) {
      ...
      return res.json(
        JSON.parse(entities.decode(JSON.stringify(recommendations)))
      );
    });
};
...
exports.update = function(req, res) {
  ...
  FootballRecommendation.findOne({ _id: id }, function(err, recommendation) {
    ...
    recommendation.user_id = req.body.user_id
      ? req.body.user_id
      : recommendation.user_id;
    recommendation.text = req.body.text ? req.body.text : recommendation.text;
    recommendation.author.author_type = req.body.author.author_type
      ? req.body.author.author_type
      : recommendation.author.author_type;
    recommendation.author.name = req.body.author.name
      ? req.body.author.name
      : recommendation.author.name;
    recommendation.author.relationship = req.body.author.relationship
      ? req.body.author.relationship
      : recommendation.author.relationship;
    recommendation.author.id = req.body.author.id
      ? req.body.author.id
      : recommendation.author.id;
    recommendation.author.avatar = req.body.author.avatar
      ? req.body.author.avatar
      : recommendation.author.avatar;
    recommendation.author.team.id = req.body.author.team.id
      ? req.body.author.team.id
      : recommendation.author.team.id;
    recommendation.author.team.acronym = req.body.author.team.acronym
      ? req.body.author.team.acronym
      : recommendation.author.team.acronym;
    recommendation.author.team.avatar = req.body.author.team.avatar
      ? req.body.author.team.avatar
      : recommendation.author.team.avatar;
    recommendation.author.team.name = req.body.author.team.name
      ? req.body.author.team.name
      : recommendation.author.team.name;
